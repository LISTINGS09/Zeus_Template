...
} else { hintSilent parseText format['A curator is already assigned!<br/>[%1]', getAssignedCuratorLogic player] };"">Assign ZEUS to %1</execute></font><br/>
...
Re-enable <font color='#66B2FF'><execute expression=""
...
<br/>
<font color='#66B2FF'><execute expression=""[player, { if (count (missionNamespace getVariable ['f_var_missionLog',[]]) > 0) then { [_this,['Diary', ['** ISSUES (Server) **', format['%1<br/>', f_var_missionLog joinString '<br/>']]]] remoteExec ['createDiaryRecord',_this]; } else { 'Server Issue log has no entries!' remoteExec ['systemChat',_this]; } }] remoteExec ['bis_fnc_spawn', 0];"">Server Issues List</execute></font><br/>
<br/>
<font color='#66B2FF'><execute expression=""openMap true; player onMapSingleClick {player setPos _pos; openMap false; onMapSingleClick ''; true;};"">Map Click Teleport</execute></font><br/>
<br/>
...
_missionWeather = "<font size='18' color='#FF7F00'>TIME / WEATHER / VIEW</font><br/>
...
<br/>
<br/>
<font color='#FF7F00'>GLOBAL VIEW DISTANCE</font>
<br/>The view distance settings below will override all those connecting and connected to the server:
<br/>
<font color='#66B2FF'><execute expression=""{setViewDistance 600; setObjectViewDistance 500} remoteExec ['BIS_fnc_spawn',0,'z_viewDist']; hintSilent 'View Distance: 500m';"">500m</execute></font> | 
<font color='#66B2FF'><execute expression=""{setViewDistance 1500; setObjectViewDistance 1000} remoteExec ['BIS_fnc_spawn',0,'z_viewDist']; hintSilent 'View Distance: 1000m';"">1000m</execute></font> | 
<font color='#66B2FF'><execute expression=""{setViewDistance 2000; setObjectViewDistance 1500} remoteExec ['BIS_fnc_spawn',0,'z_viewDist']; hintSilent 'View Distance: 1500m';"">1500m</execute></font> | 
<font color='#66B2FF'><execute expression=""{setViewDistance 2500; setObjectViewDistance 2000} remoteExec ['BIS_fnc_spawn',0,'z_viewDist']; hintSilent 'View Distance: 2000m';"">2000m</execute></font> | 
<font color='#66B2FF'><execute expression=""{setViewDistance 3000; setObjectViewDistance 2500} remoteExec ['BIS_fnc_spawn',0,'z_viewDist']; hintSilent 'View Distance: 2500m';"">2500m</execute></font> | 
<font color='#66B2FF'><execute expression=""{setViewDistance 3500; setObjectViewDistance 3000} remoteExec ['BIS_fnc_spawn',0,'z_viewDist']; hintSilent 'View Distance: 3000m';"">3000m</execute></font> | 
<font color='#66B2FF'><execute expression=""{setViewDistance 5500; setObjectViewDistance 5000} remoteExec ['BIS_fnc_spawn',0,'z_viewDist']; hintSilent 'View Distance: 5000m';"">5000m</execute></font>
<br/>
";
...
{;
	_missionEndings = _missionEndings + format [
		"<font color='#66B2FF'><execute expression=""['f_briefing_admin.sqf','End%1 called by %4','INFO'] remoteExec ['f_fnc_logIssue',2]; 'End%1' remoteExec ['BIS_fnc_endMission'];"">Ending #%1</execute></font> - %2:<br/>%3<br/><br/>",
