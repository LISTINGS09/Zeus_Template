...
if (_diaryText == "") then { _diaryText = _diaryText + "<br/><font size='18' color='#FF7F00'>ADMINISTRATION</font><br/>The following text has been auto-generated from the mission modules and parameters.<br/>" };

_diaryText = _diaryText + format["<br/>Framework Version: <font color='#72E500'>v%1</font><br/><br/>", missionNamespace getVariable ["f_var_version","0.00"]];
...
if (f_var_medical_level  > 0 && (getMissionConfigValue ["ReviveMode",0] == 0)) then {
	switch (f_var_medical_level) do {
		case 1: { // FAROOQ
			...
			_diaryText = _diaryText + "<br/>Medical Level: <font color='#72E500'><b>Revive</b></font><br/>";
			_diaryText = _diaryText + format["<br/><font color='#FF7F00'>Settings</font>
			<br/>Medic Training: <font color='#72E500'>%1</font>
			<br/>Bleedout Timer: <font color='#72E500'>%2 Seconds</font>
			<br/>Instant Death: <font color='#72E500'>%3</font>
			<br/>
			<br/>A <font color='#008080'>FAK</font color> should be used to stabilize the injured and stop the bleed-out timer.
			<br/>%4%5%6
			<br/>",
		...
		case 2: { // ACE
			...
			_diaryText = _diaryText + "<br/>Medical Level: <font color='#72E500'><b>ACE</b></font><br/>";
			_diaryText = _diaryText + format["<br/><font color='#FF7F00'>Settings</font>
			<br/>Medic Training: <font color='#72E500'>%1</font>
	...
	_diaryText = _diaryText + format["<br/>Medical Level: <font color='#72E500'>Vanilla (%1)</font><br/>", (["No Revive", "Revive Enabled", "Custom Revive"] select (getMissionConfigValue ["ReviveMode",0]))];
};
