...
zeu_dog_check = {
	...
	private _inReviveArea = count (_unit nearObjects 25 select { (_x getVariable ["ace_medical_medicClass", getNumber (configFile >> "CfgVehicles" >> typeOf _x >> "attendant")]) > 0 && !(_x isKindOf "Man") }) > 0;
