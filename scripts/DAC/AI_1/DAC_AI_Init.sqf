...
sleep 1;
publicVariable "DAC_AI_RadioDummy1";
publicVariable "DAC_AI_RadioDummy2";

{
	_x setVariable ["radio_string","",true];
	_x setVariable ["old_string","",false];
	_x setVariable ["radio_array",[],false];
	_x setVariable ["radio_dist",0,true];
} forEach [DAC_AI_RadioDummy1, DAC_AI_RadioDummy2];
