...
_i = 0;
// 2600K - Issue with deactivated groups not updating the index of deleted waypoints.
// So by NOT deleting the following, the integrity of the array index is maintained and won't error.
// Error in expression <DAC_WP_Pool_S select 324>
// Error position: <select 324>
// Error Zero divisor
