...
private [
			...
			_countrandom = 0;_max = 0;_HeloArray = [];DAC_Init_Group pushBack _DAC_Group_Typ;_run = 9;_GroupPos = [];
			_go = true;_check = 1;_maxrad = 0;_Camp_Pool = [];_groupBehav = [];_DAC_This_Zone = "";_wpConfNr = 0;_DAC_ExtraUnit = [];
			
if(_DAC_Group_Typ == 1) then
{
	{[_x] execVM "scripts\DAC\Scripts\DAC_Create_Groups.sqf"} forEach _ScriptArray;
	_run = 1;
}
else
{
...
while {_run > 0} do
{
	switch (_run) do
	{
		case 1:		{
						...
						DAC_GroupNull = call compile format["createGroup [%1,true]","Civilian"];_run = 9;
					};
		case 2:		{
		...
		case 4:		{
						...
						{
							case 1:	{
										[_countrandom,[_GroupWP,_GroupPos,_zData,_mr],1,_DAC_ZoneSide,_DAC_ZoneStart,_DAC_ZoneEnde,_maxrad,[],_GroupVar,_m,_DAC_This_Zone,_DAC_UnitTyp,"null",[_countmax,_countmin,_DAC_ZoneRadiusX,_DAC_ZoneRadiusY,_DAC_Zone_Set,_wpConfNr]] spawn DAC_fGroupSoldier;
							...
							case 2:	{
										[_countrandom,[_GroupWP,_GroupPos,_zData,_mr],2,_DAC_ZoneSide,_DAC_ZoneStart,_DAC_ZoneEnde,_maxrad,[],_GroupVar,_m,_DAC_This_Zone,_DAC_UnitTyp,"null",[_countmax,_countmin,_DAC_ZoneRadiusX,_DAC_ZoneRadiusY,_DAC_Zone_Set,_wpConfNr]] spawn DAC_fGroupVehicle;
							...
							case 3:	{
										[_countrandom,[_GroupWP,_GroupPos,_zData,_mr],3,_DAC_ZoneSide,_DAC_ZoneStart,_DAC_ZoneEnde,_maxrad,_DAC_ExtraUnit,_GroupVar,_m,_DAC_This_Zone,_DAC_UnitTyp,"null",[_countmax,_countmin,_DAC_ZoneRadiusX,_DAC_ZoneRadiusY,_DAC_Zone_Set,_wpConfNr]] spawn DAC_fGroupTank;
							...
							case 4:	{
										...
										[_countrandom,1,[_GroupWP,_GroupPos,_zData,_mr],4,_DAC_ZoneSide,_DAC_ZoneStart,_DAC_ZoneEnde,_cwp,_HeloArray,[],_GroupVar,_m,_DAC_This_Zone,_DAC_UnitTyp,_DAC_Zone_Set,_wpConfNr] spawn DAC_fGroupAir;
							...
							case 5:	{
										[_countrandom,1,_GroupWP,5,_DAC_ZoneSide,_DAC_ZoneStart,_DAC_ZoneEnde,_cwp,_HeloArray,[],_GroupVar,_m,_DAC_This_Zone,_DAC_UnitTyp,_Camp_Pool,_DAC_Zone_Set,_wpConfNr] spawn DAC_fGroupCamp;
