...
private [
			...
			_countrandom = 0;_max = 0;_HeloArray = [];DAC_Init_Group pushBack _DAC_Group_Typ;_run = 9;_GroupPos = [];_action = true;
...
{
	{[_x,_DAC_This_Zone]execVM "scripts\DAC\Scripts\DAC_New_Groups.sqf"} forEach _ScriptArray;
	_run = 1;
}
else
{
...
while {_run > 0} do
{
	switch (_run) do
	{
		case 1:		{
						...
						if(isNil "DAC_GroupNull") then {DAC_GroupNull = call compile format["createGroup [%1,true]","Civilian"]};
						_run = 9;
					};
		case 2:		{
						...
						while {_check > 0} do
						{
							switch (_check) do
							{
											...
											while {_go} do
											{
												...
												else
												{
													...
													else
													{
														if(_tz == _DAC_EnemyZone) then
														{
															_WPTempA pushBack _wp;
														}
														else
														{
															if(_active == 0) then {_WPTempB pushBack _wp};
														};
													};
												};
											};
								...
								case 6:	{
											...
											if(count _WPAll > 0) then
											{
												while {_go} do
												{
													...
													if(_tw == 0) then {_GroupWP pushBack _gwp};
								...
								case 7:	{
											...
											_GroupWP = [];_GroupWP pushBack (_WPTempA select _zc);
		...
		case 4:		{
						...
						if(_DAC_Group_Typ < 5) then
						{
							...
							while{_h < count DAC_Zones} do {_zData pushBack ((DAC_Zones select _h) select 0);_h = _h + 1};
						};
						switch (_DAC_Group_Typ) do
						{
							case 1:	{
										[_countrandom,[_GroupWP,_GroupPos,_zData,_mr],1,_DAC_ZoneSide,_DAC_ZoneStart,_DAC_ZoneEnde,_maxrad,[],_GroupVar,_m,_DAC_This_Zone,_DAC_UnitTyp,"null",[_countmax,_countmin,_DAC_ZoneRadiusX,_DAC_ZoneRadiusY,_DAC_Zone_Set,_wpConfNr]] call DAC_fGroupSoldier;
										[1,[_countrandom,[_GroupWP,_GroupPos,_zData,_mr],1,_DAC_ZoneSide,_DAC_ZoneStart,_DAC_ZoneEnde,_maxrad,[],_GroupVar,_m,_DAC_This_Zone,_DAC_UnitTyp,"null",[_countmax,_countmin,_DAC_ZoneRadiusX,_DAC_ZoneRadiusY,_DAC_Zone_Set,_wpConfNr]]] spawn DAC_fRebuildGroup;
									};
							case 2:	{
										[_countrandom,[_GroupWP,_GroupPos,_zData,_mr],2,_DAC_ZoneSide,_DAC_ZoneStart,_DAC_ZoneEnde,_maxrad,[],_GroupVar,_m,_DAC_This_Zone,_DAC_UnitTyp,"null",[_countmax,_countmin,_DAC_ZoneRadiusX,_DAC_ZoneRadiusY,_DAC_Zone_Set,_wpConfNr]] call DAC_fGroupVehicle;
										[2,[_countrandom,[_GroupWP,_GroupPos,_zData,_mr],2,_DAC_ZoneSide,_DAC_ZoneStart,_DAC_ZoneEnde,_maxrad,[],_GroupVar,_m,_DAC_This_Zone,_DAC_UnitTyp,"null",[_countmax,_countmin,_DAC_ZoneRadiusX,_DAC_ZoneRadiusY,_DAC_Zone_Set,_wpConfNr]]] spawn DAC_fRebuildGroup;
									};
							case 3:	{
										[_countrandom,[_GroupWP,_GroupPos,_zData,_mr],3,_DAC_ZoneSide,_DAC_ZoneStart,_DAC_ZoneEnde,_maxrad,_DAC_ExtraUnit,_GroupVar,_m,_DAC_This_Zone,_DAC_UnitTyp,"null",[_countmax,_countmin,_DAC_ZoneRadiusX,_DAC_ZoneRadiusY,_DAC_Zone_Set,_wpConfNr]] call DAC_fGroupTank;
										[3,[_countrandom,[_GroupWP,_GroupPos,_zData,_mr],3,_DAC_ZoneSide,_DAC_ZoneStart,_DAC_ZoneEnde,_maxrad,_DAC_ExtraUnit,_GroupVar,_m,_DAC_This_Zone,_DAC_UnitTyp,"null",[_countmax,_countmin,_DAC_ZoneRadiusX,_DAC_ZoneRadiusY,_DAC_Zone_Set,_wpConfNr]]] spawn DAC_fRebuildGroup;
									};
							case 4:	{
										if((random 100) < _mz) then {_mr = 0} else {_mr = 1};
										[_countrandom,1,[_GroupWP,_GroupPos,_zData,_mr],4,_DAC_ZoneSide,_DAC_ZoneStart,_DAC_ZoneEnde,_cwp,_HeloArray,[],_GroupVar,_m,_DAC_This_Zone,_DAC_UnitTyp,_DAC_Zone_Set,_wpConfNr] call DAC_fGroupAir;
										[4,[_countrandom,1,[_GroupWP,_GroupPos,_zData,_mr],4,_DAC_ZoneSide,_DAC_ZoneStart,_DAC_ZoneEnde,_cwp,_HeloArray,[],_GroupVar,_m,_DAC_This_Zone,_DAC_UnitTyp,_DAC_Zone_Set,_wpConfNr]] spawn DAC_fRebuildGroup;
									};
							case 5:	{
										[_countrandom,1,_GroupWP,5,_DAC_ZoneSide,_DAC_ZoneStart,_DAC_ZoneEnde,_cwp,_HeloArray,[],_GroupVar,_m,_DAC_This_Zone,_DAC_UnitTyp,_Camp_Pool,_DAC_Zone_Set,_wpConfNr] call DAC_fGroupCamp;
										[5,[_countrandom,1,_GroupWP,5,_DAC_ZoneSide,_DAC_ZoneStart,_DAC_ZoneEnde,_cwp,_HeloArray,[],_GroupVar,_m,_DAC_This_Zone,_DAC_UnitTyp,_Camp_Pool,_DAC_Zone_Set,_wpConfNr]] spawn DAC_fRebuildGroup;
									};
							Default {};
						};
						sleep random 1;
