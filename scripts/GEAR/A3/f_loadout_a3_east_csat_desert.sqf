...
_rifle = ["arifle_Katiba_F","arifle_CTAR_blk_F","arifle_CTAR_hex_F"];
...
_glrifle = ["arifle_Katiba_GL_F","arifle_CTAR_GL_blk_F","arifle_CTAR_GL_hex_F"];
...
_baseHelmet = ["H_HelmetO_ocamo","H_HelmetSpecO_ocamo"];
