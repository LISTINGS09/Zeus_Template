...
_rifle = ["arifle_CTAR_ghex_F","arifle_CTAR_blk_F","arifle_Katiba_F"];
_riflemag = "30Rnd_580x42_Mag_F";
_riflemag_tr = "30Rnd_580x42_Mag_Tracer_F";

// Standard Carabineer (Medic, Rifleman (AT), MAT Gunner, MTR Gunner, Carabineer)
_carbine = ["arifle_CTAR_ghex_F","arifle_Katiba_C_F"];
...
_glrifle = ["arifle_CTAR_GL_ghex_F","arifle_CTAR_GL_blk_F","arifle_Katiba_GL_F"];
...
_baseHelmet = ["H_HelmetO_ghex_F","H_HelmetSpecO_ghex_F"];
