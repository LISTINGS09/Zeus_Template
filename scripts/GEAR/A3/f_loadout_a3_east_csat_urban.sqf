...
// Default setup
_attachments = [_attach1,_scope2,_scope1]; // The default attachment set for most units, overwritten in the individual unitType
...
_rifle = ["arifle_Katiba_F","arifle_CTAR_blk_F"];
...
_glrifle = ["arifle_Katiba_GL_F","arifle_CTAR_GL_blk_F"];
...
// Automatic Rifleman
_AR = ["LMG_Zafir_F","arifle_CTARS_blk_F"];
_ARmag = "150Rnd_762x54_Box";
_ARmag_tr = "150Rnd_762x54_Box_Tracer";

// Medium MG
_MMG = ["LMG_Zafir_F","MMG_01_tan_F"];
_MMGmag = "150Rnd_762x54_Box";
_MMGmag_tr = "150Rnd_762x54_Box_Tracer";

// Marksman rifle
_DMrifle = ["srifle_DMR_01_F","srifle_DMR_07_blk_F","srifle_DMR_05_blk_F","srifle_DMR_04_F"];
...
// Sniper
_SNrifle = ["srifle_GM6_F","srifle_DMR_05_blk_F","srifle_DMR_04_F"];
...
_mediumRig = ["V_PlateCarrier1_blk","V_PlateCarrier2_blk","V_TacVestIR_blk"]; 	// default for all infantry classes
...
if (_isMan) then {
	...
	_unit addItem "H_Bandanna_gry";	// Free Hat!
};
// ====================================================================================
...
// LOADOUT: CARABINEER
   ...
   default
   {
		...
		if (true) exitWith {diag_log text format ["[F3] DEBUG (f_loadout_a3_csat_u.sqf): Unit = %1. Gear template %2 does not exist!",_unit,_typeOfUnit]};
   };
