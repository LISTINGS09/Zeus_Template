...
_rifle = ["arifle_ARX_blk_F","arifle_CTAR_blk_F","arifle_Katiba_F"];
...
_smg = "arifle_Katiba_C_F";
_smgmag = "30Rnd_65x39_caseless_green";
_smgmag_tr = "30Rnd_65x39_caseless_green_mag_Tracer";
...
_glrifle = ["arifle_CTAR_GL_blk_F","arifle_Katiba_GL_F"];
...
_bagmedium = "B_ViperLightHarness_oli_F";	// carries 200, weighs 30
_baglarge =  "B_ViperHarness_oli_F"; 		// carries 320, weighs 40
...
if (_isMan) then {
	...
	_unit addItem "H_Beret_blk";	// Free Hat!
};
// ====================================================================================
