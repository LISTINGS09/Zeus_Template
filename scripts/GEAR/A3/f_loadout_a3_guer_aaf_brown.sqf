...
_scope2 = ["optic_MRCO","optic_Hamr"]; // Low
...
// Marksman rifle
// NON-DLC ALTERNATIVE:
_DMrifle = ["srifle_DMR_05_tan_f","srifle_DMR_07_blk_F","srifle_DMR_03_tan_F","srifle_DMR_03_F"];
...
// Pilot
_pilotUniform = ["U_I_CombatUniform"];
_pilotHelmet = ["H_Booniehat_tan"];
_pilotRig = ["V_TacVest_khk"];
_pilotGlasses = [];

// Crewman
_crewUniform = ["U_I_CombatUniform"];
_crewHelmet = ["H_Booniehat_tan"];
