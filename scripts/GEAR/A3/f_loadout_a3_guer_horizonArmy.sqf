...
_baseUniform = ["U_I_C_Soldier_Camo_F","U_I_C_Soldier_Camo_F","U_I_C_Soldier_Para_3_F"];
_baseHelmet = ["H_HelmetB","H_HelmetB","H_HelmetB_paint"];
_baseGlasses = ["G_Bandanna_oli","G_Shades_Black","",""];
