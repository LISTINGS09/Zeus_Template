...
_scope2 = ["optic_MRCO","optic_Arco","optic_Hamr","optic_ERCO_blk_F"]; // Low
...
_rifle = "sgun_HunterShotgun_01_F";
_riflemag = "2Rnd_12Gauge_Pellets";
_riflemag_tr = "2Rnd_12Gauge_Pellets";

// Standard Carabineer (Medic, Rifleman (AT), MAT Gunner, MTR Gunner, Carabineer)
_carbine = "sgun_HunterShotgun_01_sawedoff_F";
_carbinemag = "2Rnd_12Gauge_Pellets";
_carbinemag_tr = "2Rnd_12Gauge_Pellets";

// Standard Submachine Gun/Personal Defence Weapon (Aircraft Pilot, Submachinegunner)
_smg = "sgun_HunterShotgun_01_sawedoff_F";
_smgmag = "2Rnd_12Gauge_Pellets";
_smgmag_tr = "2Rnd_12Gauge_Pellets";
...
_glrifle = "sgun_HunterShotgun_01_F";
_glriflemag = "2Rnd_12Gauge_Pellets";
_glriflemag_tr = "2Rnd_12Gauge_Pellets";
_glmag = "2Rnd_12Gauge_Slug";

// Smoke for FTLs, Squad Leaders, etc
_glsmoke = "SmokeShell";
_glsmokealt1 = "SmokeShellGreen";
_glsmokealt2 = "SmokeShellYellow";
...
// Backpacks
_bagsmall = "B_AssaultPack_tna_F";			// carries 160, weighs 20
...
// Automatic Rifleman
_AR = "SMG_03C_TR_black";
_ARmag = "50Rnd_570x28_SMG_03";
_ARmag_tr = "50Rnd_570x28_SMG_03";

// Medium MG
// NON-DLC ALTERNATIVE:
_MMG = ["LMG_03_F","LMG_Mk200_F"];
...
// Sniper
_SNrifle = ["srifle_GM6_F","srifle_LRR_F"];
...
_baseUniform = ["U_I_L_Uniform_01_tshirt_skull_F","U_I_L_Uniform_01_tshirt_black_F","U_C_E_LooterJacket_01_F","U_I_C_Soldier_Bandit_3_F","U_I_C_Soldier_Bandit_2_F"];
_baseHelmet = ["H_Bandanna_gry","H_Bandanna_cbr","H_Cap_red","H_Cap_oli",""];
_baseGlasses = ["G_Shades_Black","","G_Bandanna_oli","","G_Shades_Blue","G_Bandanna_shades","G_Bandanna_khk","G_Sport_Blackred",""];

// Vests
_lightRig = ["V_TacChestrig_cbr_F","V_TacChestrig_grn_F","V_TacChestrig_oli_F"];
_mediumRig = ["V_TacVest_blk","V_TacVest_oli"]; 	// default for all infantry classes
...
_pilotHelmet = ["H_Cap_headphones","H_Cap_marshal"];
_pilotRig = _lightRig;
_pilotGlasses = _baseGlasses;

// Crewman
_crewUniform = _baseUniform;
_crewHelmet = ["H_Cap_headphones","H_Cap_marshal"];
_crewRig = _lightRig;
...
// Spec Op (CTRG)
_sfuniform = "U_C_CBRN_Suit_01_White_F";
_sfhelmet = "H_PASGT_basic_white_F";
_sfRig = _mediumRig;
