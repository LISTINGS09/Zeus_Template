...
_baseHelmet = ["H_Bandanna_camo","H_Bandanna_sgg"];
...
// Vests
_lightRig = "V_TacChestrig_oli_F";
_mediumRig = "V_TacVest_camo"; 	// default for all infantry classes
