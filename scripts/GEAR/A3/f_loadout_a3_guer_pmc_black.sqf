...
_rifle = ["arifle_SPAR_01_blk_F","arifle_MX_Black_F"];
_riflemag = "30Rnd_556x45_Stanag";
_riflemag_tr = "30Rnd_556x45_Stanag_Tracer_Red";

// Standard Carabineer (Medic, Rifleman (AT), MAT Gunner, MTR Gunner, Carabineer)
_carbine = ["arifle_SPAR_01_blk_F","arifle_MXC_Black_F"];
...
_glrifle = ["arifle_SPAR_01_GL_blk_F","arifle_MX_GL_Black_F"];
...
// UAV Terminal
_uavterminal = "I_UavTerminal";	  // INDEP
...
_baglarge =  "B_Carryall_blk"; 				// carries 320, weighs 60
...
// Marksman rifle
_DMrifle = ["srifle_DMR_03_F","arifle_SPAR_03_blk_F","srifle_DMR_02_F","srifle_DMR_06_camo_F"];
...
// Sniper
_SNrifle = ["srifle_LRR_F","srifle_DMR_02_camo_F","srifle_DMR_02_F"];
...
_baseGlasses = ["","G_Balaclava_Skull1","G_Balaclava_blk","G_Balaclava_Flames1","G_Bandanna_aviator","G_Bandanna_CandySkull","G_Bandanna_OrangeFlame1","G_Bandanna_RedFlame1","G_Bandanna_Skull1","G_Aviator"];
...
_ghillieRig = "V_I_G_resistanceLeader_F";
_ghillieGlasses = [];
...
if (_isMan) then {
	...
	_unit addItem "H_Cap_Lyfe";		// Free hat!
};
