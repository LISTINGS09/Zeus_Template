...
_baseUniform = ["U_BG_Guerilla1_1","U_C_IDAP_Man_Jeans_F"];
...
// Crewman
_crewUniform = "U_C_IDAP_Man_Jeans_F";
_crewHelmet = "H_HelmetCrew_B";
_crewRig = "V_TacVest_blk";
_crewGlasses = [];

// Ghillie
_ghillieUniform = "U_C_IDAP_Man_Jeans_F";
...
if (_isMan) then {
	...
	_unit addItem "H_Cap_usblack";// Free Hat!
};
