...
// Backpacks
_bagsmall = "B_AssaultPack_khk";			// carries 160, weighs 20
_bagmedium = "B_FieldPack_oli";				// carries 200, weighs 30
_baglarge =  "B_ViperLightHarness_blk_F";	// carries 320, weighs 60
...
_baseUniform = ["U_I_C_Soldier_Camo_F","U_I_C_Soldier_Para_2_F","U_I_C_Soldier_Para_3_F"];
_baseHelmet = ["H_Booniehat_khk","H_Booniehat_oli"];
_baseGlasses = ["G_Bandanna_oli","","G_Bandanna_blk","G_Bandanna_khk"];
...
// LOADOUT: CARABINEER
   ...
   default
   {
		...
		if (true) exitWith {diag_log text format ["[F3] DEBUG (f_loadout_a3_guer.syndikat.sqf): Unit = %1. Gear template %2 does not exist!",_unit,_typeOfUnit]};
   };
