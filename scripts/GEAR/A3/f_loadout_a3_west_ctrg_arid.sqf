...
_scope2 = ["optic_MRCO","optic_Hamr","optic_ERCO_blk_F"]; // Low
...
_glrifle = ["arifle_MX_GL_Black_F","arifle_SPAR_01_GL_blk_F"];
...
// Automatic Rifleman
_AR = ["LMG_03_F","arifle_MX_SW_Black_F","arifle_SPAR_02_blk_F"];
