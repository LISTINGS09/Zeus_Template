...
_scope3 = ["optic_SOS","optic_AMS","optic_AMS_snd"]; // Medium
_scope4 = ["optic_LRPS_tna_F","optic_LRPS","optic_AMS","optic_AMS_snd"]; // High
...
_rifle = ["arifle_MX_F","arifle_Mk20_plain_F","arifle_SPAR_01_snd_F"];
_riflemag = "30Rnd_65x39_caseless_mag";
_riflemag_tr = "30Rnd_65x39_caseless_mag_Tracer";

// Standard Carabineer (Medic, Rifleman (AT), MAT Gunner, MTR Gunner, Carabineer)
_carbine = ["arifle_MXC_F","arifle_Mk20C_plain_F","arifle_SPAR_01_snd_F"];
...
_glrifle = ["arifle_MX_GL_F","arifle_Mk20_GL_plain_F","arifle_SPAR_01_GL_snd_F"];
...
// Automatic Rifleman
_AR = ["arifle_MX_SW_F","arifle_SPAR_02_snd_F"];
...
// Marksman rifle
_DMrifle = ["arifle_MXM_F","srifle_EBR_F","srifle_DMR_02_camo_F","srifle_DMR_03_tan_F","arifle_SPAR_03_snd_F"];
...
_mediumRig = ["V_PlateCarrierSpec_mtp"]; 	// default for all infantry classes
