...
_scope2 = ["optic_Hamr","optic_Arco_AK_blk_F","optic_ERCO_blk_F","optic_MRCO"]; // Low
...
_rifle = ["arifle_TRG21_F","arifle_Mk20_plain_F","arifle_AKM_F"];
_riflemag = "30Rnd_556x45_Stanag";
_riflemag_tr = "30Rnd_556x45_Stanag_Tracer_Red";

// Standard Carabineer (Medic, Rifleman (AT), MAT Gunner, MTR Gunner, Carabineer)
_carbine = ["arifle_TRG20_F","arifle_Mk20C_plain_F","arifle_AKS_F"];
...
_glrifle = ["arifle_TRG21_GL_F","arifle_Mk20_GL_plain_F","arifle_AK12_GL_F"];
...
_baseHelmet = ["H_Bandanna_khk","H_Cap_oli","H_Watchcap_blk"];
