...
_scope3 = ["optic_DMS","optic_SOS","optic_AMS","optic_NVS"]; // Medium
...
// Automatic Rifleman
_AR = ["arifle_SPAR_02_blk_F","LMG_Mk200_F","LMG_03_F"];
...
// Marksman rifle
_DMrifle = ["arifle_SPAR_03_blk_F","srifle_DMR_03_F","srifle_DMR_07_blk_F"];
...
_baseHelmet = "H_PASGT_basic_blue_F";
_baseGlasses = ["G_Balaclava_blk","G_Balaclava_lowprofile","G_Balaclava_blk"];
...
// Pilot
_pilotUniform = "U_B_GEN_Soldier_F";
_pilotHelmet = "H_Cap_marshal";
_pilotRig = "V_TacVest_gen_F";
_pilotGlasses = [];

// Crewman
_crewUniform = "U_B_GEN_Soldier_F";
_crewHelmet = "H_Cap_marshal";
_crewRig = "V_TacVest_gen_F";
_crewGlasses = [];

// Ghillie
_ghillieUniform = "U_B_GEN_Soldier_F";
_ghillieHelmet = "H_MilCap_gen_F";
_ghillieRig = "V_TacVest_gen_F";
_ghillieGlasses = [];
...
// LOADOUT: CARABINEER
   ...
   default
   {
		...
		if (true) exitWith {diag_log text format ["[F3] DEBUG (f_loadout_a3_west.gendarmerie.sqf): Unit = %1. Gear template %2 does not exist!",_unit,_typeOfUnit]};
   };
