...
// Automatic Rifleman
_AR = ["arifle_MX_SW_Black_F","arifle_SPAR_02_blk_F","LMG_Mk200_F","LMG_03_F"];
...
// Marksman rifle
_DMrifle = ["arifle_MXM_Black_F","arifle_SPAR_03_blk_F","srifle_DMR_03_F","srifle_DMR_07_blk_F"];
