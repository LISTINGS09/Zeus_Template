...
// Medium AT
_MAT = ["launch_RPG32_green_F","launch_MRAWS_green_rail_F"];
_MATmag1 = "RPG32_F";
_MATmag2 = "RPG32_HE_F";
...
_baseHelmet = ["H_Construction_basic_red_F"];
_baseGlasses = ["G_Bandanna_blk","","G_Bandanna_beast","G_Bandanna_sport",""];

// Vests
_lightRig = "V_Safety_orange_F";
_mediumRig = "V_Safety_orange_F"; 	// default for all infantry classes
_heavyRig = "V_DeckCrew_red_F";
...
switch (_typeOfUnit) do
{
	...
	case "co":
	{
		_unit addHeadGear "H_Construction_basic_orange_F";
		["g"] call _backpack;
...
// LOADOUT: CARABINEER
   ...
   default
   {
		...
		if (true) exitWith {diag_log text format ["[F3] DEBUG (f_loadout_a3_west_fia.sqf): Unit = %1. Gear template %2 does not exist!",_unit,_typeOfUnit]};
   };
