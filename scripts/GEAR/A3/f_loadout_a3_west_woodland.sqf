...
_flashHider = "";
_silencer1 = ["muzzle_snds_H_snd_F","muzzle_snds_H","muzzle_snds_M"]; // Rifleman
...
// Default setup
_attachments = [_attach1,_scope2,_scope1,_bipod1]; // The default attachment set for most units, overwritten in the individual unitType
...
// Marksman rifle
_DMrifle = ["arifle_MXM_Black_F","srifle_DMR_03_F","srifle_DMR_06_olive_F"];
...
// Sniper
_SNrifle = ["srifle_LRR_F","srifle_DMR_02_F"];
...
// Vests
_lightRig = ["V_PlateCarrier1_wdl"];
_mediumRig = ["V_PlateCarrier2_wdl"]; 	// default for all infantry classes
_heavyRig = ["V_PlateCarrierGL_wdl"];
