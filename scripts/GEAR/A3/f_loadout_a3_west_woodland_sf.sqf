...
_flashHider = "";
_silencer1 = ["muzzle_snds_65_TI_blk_F","muzzle_snds_M"]; // Rifleman
...
_scope2 = ["optic_Hamr","optic_Hamr_khk_F","optic_ERCO_khk_F","optic_ERCO_blk_F","optic_MRCO"]; // Low
_scope3 = ["optic_SOS","optic_SOS_khk_F","optic_AMS","optic_AMS_khk","optic_NVS"]; // Medium
_scope4 = ["optic_LRPS","optic_LRPS_tna_F","optic_AMS","optic_AMS_khk","optic_Nightstalker"]; // High

_bipod1 = ["bipod_01_F_blk","bipod_01_F_mtp"];

// Default setup
_attachments = [_attach1,_scope2,_bipod1,_silencer1]; // The default attachment set for most units, overwritten in the individual unitType

// Predefined Class Attachment Setup
_attach_co = [_attach1,_scope2,_bipod1,_silencer1];
_attach_dc = [_attach1,_scope2,_bipod1,_silencer1]; // Also SL!
_attach_fl = [_attach1,_scope2,_bipod1,_silencer1];
_attach_mg = [_attach1,_scope2,_bipod1,_silencer1];
_attach_dm = [_scope3,_bipod1,_silencer1];
...
_glrifle = ["arifle_msbs65_gl_camo_f","arifle_msbs65_gl_f","arifle_msbs65_gl_black_f"];
...
// Backpacks
_bagsmall = "B_AssaultPack_wdl_F";			// carries 120, weighs 20
_bagmedium = "B_Kitbag_sgg";				// carries 240, weighs 30
_baglarge =  "B_Carryall_wdl_F"; 			// carries 320, weighs 40
...
_mediumRig = ["V_PlateCarrier2_blk"]; 	// default for all infantry classes
...
// Ghillie
_ghillieUniform = ["U_B_FullGhillie_lsh"]; //DLC alternatives: ["U_B_FullGhillie_lsh","U_B_FullGhillie_ard","U_B_FullGhillie_sard"];
_ghillieHelmet = [];
_ghillieRig = ["V_Chestrig_rgr"];
_ghillieGlasses = [];

// Spec Op
_sfuniform = ["U_B_CBRN_Suit_01_Wdl_F"];
_sfhelmet = ["H_HelmetB_plain_wdl"];
_sfRig = ["V_PlateCarrier1_wdl"];
_sfGlasses = ["G_AirPurifyingRespirator_01_F"];
...
switch (_typeOfUnit) do
{
	...
	case "co":
	{
		_unit addHeadGear "H_MilCap_wdl";
		["g"] call _backpack;
