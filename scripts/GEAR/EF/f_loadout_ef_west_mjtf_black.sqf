...
_flashHider = "";
_silencer1 = ["ef_snds_mxar","muzzle_snds_H_snd_F","muzzle_snds_H","muzzle_snds_M"]; // Rifleman
_silencer2 = ["muzzle_snds_H_MG_snd_F","muzzle_snds_H_MG","muzzle_snds_M"]; // MG

_scope1 = ["optic_Holosight_blk_F","ef_optic_microsight","optic_ACO","optic_ACO_grn"]; // CQB
_scope2 = ["ef_optic_mbs","optic_ERCO_blk_F","optic_Hamr","optic_MRCO"]; // Low
...
_glrifle = ["ef_arifle_mxar_gl_black","arifle_MX_GL_Black_F"];
...
// Backpacks
_bagsmall = "EF_B_RaiderPack_black";			// carries 120, weighs 20
_bagmedium = "B_FieldPack_blk";				// carries 240, weighs 30
_baglarge =  "B_Carryall_blk"; 			// carries 320, weighs 40
...
// Automatic Rifleman
_AR = ["LMG_Mk200_black_F","arifle_MX_SW_Black_F"];
...
// Marksman rifle
_DMrifle = ["arifle_MXM_Black_F","srifle_EBR_F","srifle_DMR_02_camo_F","srifle_DMR_03_tan_F"];
...
_baseUniform = ["U_O_R_Gorka_01_black_F"];
_baseHelmet = ["EF_H_HelmetB_light_black_slick"];
_baseGlasses = [""];

// Vests
_lightRig = ["EF_V_AAV_Scout_Black"];
_mediumRig = ["EF_V_AAV_Rifleman_Black"]; 	// default for all infantry classes
_heavyRig = ["EF_V_AAV_Support_Black"];
...
if (_isMan) then {
	...
	_unit addItem "H_Watchcap_blk"; // Free Hat!
};
...
// LOADOUT: CARABINEER
   ...
   default
   {
		...
		if (true) exitWith {diag_log text format ["[F3] DEBUG (f_loadout_ef_west_mjtf_black.sqf): Unit = %1. Gear template %2 does not exist!",_unit,_typeOfUnit]};
   };
