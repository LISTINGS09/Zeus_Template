...
_bipod1 = ["bipod_01_F_khk","bipod_01_F_blk"];
...
// Marksman rifle
_DMrifle = ["ef_arifle_MXM_coy","srifle_DMR_03_F","arifle_SPAR_03_blk_F","arifle_SPAR_03_khk_F","srifle_DMR_02_camo_F","srifle_DMR_06_camo_F","srifle_DMR_03_khaki_F"];
...
_baseUniform = ["EF_U_B_MarineCombatUniform_Wdl_1","EF_U_B_MarineCombatUniform_Wdl_2","EF_U_B_MarineCombatUniform_Wdl_3","EF_U_B_MarineCombatUniform_Wdl_5"];
_baseHelmet = ["ef_H_MCH_Basic","ef_H_MCH_BasicNet_coy","ef_H_MCH_BasicNet_des"];
_baseGlasses = [""];
...
if (_isMan) then {
	...
	_unit addItem "EF_H_Booniehat_Wdl"; // Free Hat!
};
...
switch (_typeOfUnit) do
{
	...
	case "co":
	{
		...
		_unit addHeadgear "EF_H_UtilityCap_Wdl";
	};
...
// LOADOUT: CARABINEER
   ...
   default
   {
		...
		if (true) exitWith {diag_log text format ["[F3] DEBUG (f_loadout_ef_west_mjtf_semiarid.sqf): Unit = %1. Gear template %2 does not exist!",_unit,_typeOfUnit]};
   };
