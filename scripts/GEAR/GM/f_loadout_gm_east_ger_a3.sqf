...
_baseHelmet = ["gm_gc_army_headgear_m56_net","gm_gc_army_headgear_m56"];
_baseGlasses = [""];
...
switch (_typeOfUnit) do
{
	...
	{
		["g"] call _backpack;
		_unit addHeadGear "gm_gc_army_headgear_hat_80_grn";
	...
	case "m":
	{
		_unit addHeadGear "gm_gc_army_headgear_m56_cover_str";
