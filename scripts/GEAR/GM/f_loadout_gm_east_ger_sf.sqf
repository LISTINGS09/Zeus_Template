...
_baseUniform = ["gm_gc_army_uniform_soldier_80_str","gm_gc_army_uniform_soldier_gloves_80_str"];
_baseHelmet = ["gm_gc_headgear_fjh_model4_oli"];
_baseGlasses = [""];

// Vests
_lightRig = "gm_gc_vest_combatvest3_str";
_mediumRig = "gm_gc_vest_combatvest3_str"; 	// default for all infantry classes
_heavyRig = "gm_gc_vest_combatvest3_str";
...
// Pilot
_pilotUniform = "gm_gc_army_uniform_soldier_gloves_80_str";
_pilotHelmet = "gm_ge_headgear_headset_crew_oli";
_pilotRig = "gm_gc_army_vest_80_belt_str";
_pilotGlasses = [];

// Crewman
_crewUniform = "gm_gc_army_uniform_soldier_gloves_80_str";
...
if (_isMan) then {
	...
	_unit addItem "gm_gc_headgear_beret_str";
};
...
switch (_typeOfUnit) do
{
	...
	{
		["g"] call _backpack;
		_unit addHeadGear "gm_gc_headgear_beret_blk";
