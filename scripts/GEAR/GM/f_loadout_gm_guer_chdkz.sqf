...
_baseUniform = ["gmx_chdkz_army_uniform_soldier_01_mix_01","gmx_chdkz_army_uniform_soldier_01_mix_03","gmx_chdkz_army_uniform_soldier_02_mix_03","gmx_chdkz_army_uniform_soldier_01_wdl"];
_baseHelmet = ["H_Bandanna_khk"];
_baseGlasses = ["","","G_Bandanna_oli","G_Balaclava_blk","G_Bandanna_blk"];

// Vests
_lightRig = "gm_pl_army_vest_80_crew_gry";
_mediumRig = "gm_pl_army_vest_80_rifleman_gry"; 	// default for all infantry classes
...
if (_isMan) then {
	...
	_unit addItem "gm_ge_headgear_beret_bdx_specop";
};
...
switch (_typeOfUnit) do
{
	...
	{
		["g"] call _backpack;
		_unit addHeadGear "gm_pl_army_headgear_cap_80_frog";
