...
_baseUniform = ["U_BG_Guerilla1_1","U_BG_Guerilla1_2_F","U_BG_leader"];
_baseHelmet = ["H_Booniehat_dgtl","H_HelmetIA"];
_baseGlasses = [""];

// Vests
_lightRig = "gmx_cdf2022_army_vest_90_rifleman_oli";
_mediumRig = "gmx_cdf2022_army_vest_90_leader_oli"; 	// default for all infantry classes
...
_ghillieHelmet = "H_Booniehat_dgtl";
