...
// ATTACHMENTS - PRIMARY
_attach1 = "gm_flashlightp2_wht_akhandguard_blu";
_attach2 = "";
...
// Default setup
_attachments = [_scope1,_attach1]; // The default attachment set for most units, overwritten in the individual unitType

// Predefined Class Attachment Setup
_attach_co = [_scope1,_attach1];
_attach_dc = [_scope1,_attach1]; // Also SL!
_attach_fl = [_scope1,_attach1];
_attach_mg = [];
_attach_dm = [_scope3];
_attach_sn = [_scope4];
...
_pistol = "gm_pm_blk";
_pistolmag = "gm_8Rnd_9x18mm_B_pst_pm_blk";
...
// UAV Terminal
_uavterminal = "O_UavTerminal";	  // OPFOR - Russia
...
_baglarge =  "gm_ge_army_backpack_90_oli";
...
_baghatg = "gm_fagot_launcher_weaponBag";	// used by Heavy AT gunner
_baghatag = "gm_fagot_launcher_weaponBag";	// used by Heavy AT assistant gunner
...
// Vests
_lightRig = "V_CarrierRigKBT_01_light_Olive_F";
...
_ghillieHelmet = "gm_dk_headgear_m96_cover_m84";
_ghillieRig = "V_CarrierRigKBT_01_light_Olive_F";
_ghillieGlasses = [];
...
if (_isMan) then {
	...
	_unit addItem "gm_xx_headgear_headwrap_01_m84"; // Free hat!
};
...
switch (_typeOfUnit) do
{
	...
	{
		["g"] call _backpack;
		_unit addHeadGear "gm_ge_headgear_beret_un";
