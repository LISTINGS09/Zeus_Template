...
_baseUniform = ["U_I_C_Soldier_Para_2_F","U_I_C_Soldier_Para_3_F","U_I_C_Soldier_Para_1_F"];
_baseHelmet = ["gmx_cdf2022_army_headgear_m92_glasses_oli","gmx_cdf2022_army_headgear_m92_oli"];
_baseGlasses = [""];

// Vests
_lightRig = "gmx_cdf2022_army_vest_90_rifleman_oli";
_mediumRig = "gmx_cdf2022_army_vest_90_demolition_oli"; 	// default for all infantry classes
_heavyRig = "gmx_cdf2022_army_vest_90_machinegunner_oli";
