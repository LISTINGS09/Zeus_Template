...
_scope1 = ["optic_Holosight_blk_F","optic_Arco_AK_blk_F"]; // CQB
_scope2 = ["optic_Holosight_blk_F","optic_Arco_AK_blk_F"]; // Low
...
_rifle = ["arifle_AK12_F","arifle_AK12U_F"];
...
_baseUniform = ["gmx_cdf2022_army_uniform_soldier_digittsko","gmx_cdf2022_army_uniform_soldier_rolled_digittsko"];
_baseHelmet = ["H_HelmetB_light"];
