...
_attach_dc = [_flashHider,_scope1,_attach1]; // Also SL!
_attach_fl = [_flashHider,_scope1,_attach1];
_attach_mg = [_scope1,_bipod1];
...
_baseHelmet = "rhsgref_helmet_pasgt_altis_lizard";
_baseGlasses = "";

// Vests
_lightRig = "rhssaf_vest_md99_md2camo_radio";
_mediumRig = "rhssaf_vest_md99_md2camo_rifleman_radio"; 	// default for all infantry classes
...
// Pilot
_pilotUniform = ["rhsgref_uniform_altis_lizard"];
_pilotHelmet = ["tb_alfr_headset_01"];
_pilotRig = ["rhssaf_vest_md98_md2camo"];
_pilotGlasses = [];

// Crewman
_crewUniform = ["rhsgref_uniform_altis_lizard"];
_crewHelmet = ["tb_alfr_headset_01"];
_crewRig = ["rhssaf_vest_md98_md2camo"];
_crewGlasses = [];
