...
_silencer1 = ["muzzle_snds_M","muzzle_snds_H"]; // INF suppressor
...
_scope3 = ["rhsusf_acc_ACOG_RMR","optic_MRCO","optic_DMS","optic_SOS"]; // DMR
_scope4 = ["optic_SOS","optic_AMS_khk","optic_AMS","FHQ_optic_LeupoldERT","optic_LRPS"]; // SNP
...
_riflemag = "hlc_20Rnd_762x51_T_fal";
_riflemag_tr = "hlc_20Rnd_762x51_T_fal";

// Standard Carabineer (Medic, Rifleman (AT), MAT Gunner, MTR Gunner, Carabineer)
_carbine = "hlc_rifle_L1A1SLR";
_carbinemag = "hlc_20Rnd_762x51_T_fal";
...
// Diver
_diverWep = "SMG_02_F";
_diverMag1 = "30Rnd_9x21_Mag";
_diverMag2 = "30Rnd_9x21_Yellow_Mag";
...
_bagmedium = "rhssaf_kitbag_digital";		// carries 240, weighs 30
...
// Marksman rifle
_DMrifle = ["rhs_weap_m14ebrri","srifle_DMR_03_F","srifle_DMR_03_khaki_F","srifle_DMR_06_olive_F"];
...
// Sniper
_SNrifle = ["rhs_weap_sr25","srifle_DMR_02_sniper_F","srifle_GM6_F"];
...
_baseUniform = ["rhssaf_uniform_m10_digital_summer"];
_baseHelmet = "rhssaf_helmet_m97_digital";
_baseGlasses = "";

// Vests
_lightRig = "rhssaf_vest_md99_digital";
_mediumRig = "rhssaf_vest_md99_digital_rifleman"; 	// default for all infantry classes
_heavyRig = "rhsgref_otv_digi";
...
// Ghillie
_ghillieUniform = ["U_B_DAN_CombatUniform"]; //DLC alternatives: ["U_B_FullGhillie_lsh","U_B_FullGhillie_ard","U_B_FullGhillie_sard"];
_ghillieHelmet = ["H_Watchcap_camo"];
_ghillieRig = ["V_TacVest_oli"];
_ghillieGlasses = [];

// Spec Op
_sfuniform = ["U_B_DAN_CombatUniform"];
...
switch (_typeofUnit) do
{
	...
	case "co":
	{
		_unit addHeadGear "tb_alfr_booniehat";
		["g"] call _backpack;
...
// LOADOUT: CARABINEER
   ...
   default
   {
		...
		if (true) exitWith {diag_log text format ["[F3] DEBUG (f\assignGear\f_loadout_rhs_pathfinder_w.sqf): Unit = %1. Gear template %2 does not exist, used Rifleman instead.",_unit,_typeofUnit]};
   };
