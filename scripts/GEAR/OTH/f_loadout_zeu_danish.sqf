...
_bagmedium = "B_DAN_Kitbag_danish";			// carries 240, weighs 30
...
_baseUniform = ["U_B_DAN_CombatUniform_shortsleeve","U_B_DAN_CombatUniform"];
_baseHelmet = "H_DAN_Helmet";
_baseGlasses = ["G_Combat",""];

// Vests
_lightRig = "V_PlateCarrierL_Danish";
_mediumRig = "V_PlateCarrierL_Danish"; 	// default for all infantry classes
_heavyRig = "V_PlateCarrierH_Danish";
