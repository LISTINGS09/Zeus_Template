...
_rifle = ["rhs_weap_akm","rhs_weap_akms","rhs_weap_ak103","rhs_weap_ak74m_desert","rhs_weap_ak74m"];
_riflemag = "rhs_30Rnd_762x39mm";
_riflemag_tr = "rhs_30Rnd_762x39mm_tracer";

// Standard Carabineer (Medic, Rifleman (AT), MAT Gunner, MTR Gunner, Carabineer)
_carbine = ["rhs_weap_akm","rhs_weap_akms","rhs_weap_ak103","rhs_weap_ak74m_desert_folded","rhs_weap_ak74m_folded"];
_carbinemag = "rhs_30Rnd_762x39mm";
_carbinemag_tr = "rhs_30Rnd_762x39mm_tracer";

// Standard Submachine Gun/Personal Defence Weapon (Aircraft Pilot, Submachinegunner)
_smg = ["rhs_weap_ak74m_desert_folded","rhs_weap_ak74m_folded"];
...
// Woodland-Hex
_baseUniform = ["U_TAK_Takiban_01_1","U_TAK_Takiban_03_2","U_TAK_Takiban_05_3","U_TAK_Takiban_04_2"];
_baseHelmet = ["H_takihat_1","H_takihat_2","H_takihat_3",""];
...
// Pilot
_pilotUniform = ["U_TAK_Takiban_01_1","U_TAK_Takiban_03_2","U_TAK_Takiban_05_3","U_TAK_Takiban_04_2"];
_pilotHelmet = ["rhs_tsh4"];
_pilotRig = ["rhs_6b23_digi"];
_pilotGlasses = [];

// Crewman
_crewUniform = ["U_TAK_Takiban_01_1","U_TAK_Takiban_03_2","U_TAK_Takiban_05_3","U_TAK_Takiban_04_2"];
...
// LOADOUT: CARABINEER
   ...
   default
   {
		...
		if (true) exitWith {diag_log text format ["[F3] DEBUG (f\assignGear\f_loadout_zeu_takiban_d.sqf): Unit = %1. Gear template %2 does not exist, used Rifleman instead.",_unit,_typeofUnit]};
   };
