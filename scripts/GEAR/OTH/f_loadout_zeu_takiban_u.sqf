...
_rifle = ["rhs_weap_akm","rhs_weap_akms","rhs_weap_ak103","rhs_weap_ak74m"];
...
// Woodland-Hex
_baseUniform = ["U_TAK_Takiban_01_2","U_TAK_Takiban_03_3","U_TAK_Takiban_05_2","U_TAK_Takiban_04_3"];
_baseHelmet = ["H_ShemagOpen_khk","H_ShemagOpen_tan",""];
...
// Pilot
_pilotUniform = ["U_TAK_Takiban_01_2","U_TAK_Takiban_03_3","U_TAK_Takiban_05_2","U_TAK_Takiban_04_3"];
_pilotHelmet = ["rhs_tsh4"];
_pilotRig = ["rhs_6b23_digi"];
_pilotGlasses = [];

// Crewman
_crewUniform = ["U_TAK_Takiban_01_2","U_TAK_Takiban_03_3","U_TAK_Takiban_05_2","U_TAK_Takiban_04_3"];
...
// LOADOUT: CARABINEER
   ...
   default
   {
		...
		if (true) exitWith {diag_log text format ["[F3] DEBUG (f\assignGear\f_loadout_zeu_takiban_u.sqf): Unit = %1. Gear template %2 does not exist, used Rifleman instead.",_unit,_typeofUnit]};
   };
