...
_flashHider = "";
_silencer1 = ["suppressor_65_black_RF","muzzle_snds_H","muzzle_snds_M"]; // Rifleman
_silencer2 = ["suppressor_65_black_RF","muzzle_snds_H"]; // MG

_scope1 = ["optic_ACO","optic_ACO_grn"]; // CQB
_scope2 = ["optic_VRCO_RF","optic_MRCO","optic_Hamr"]; // Low
_scope3 = ["optic_SOS","optic_AMS","optic_AMS_khk","optic_NVS"]; // Medium
_scope4 = ["optic_LRPS","optic_AMS","optic_AMS_khk","optic_Nightstalker"]; // High

_bipod1 = ["bipod_03_F_blk","bipod_03_F_oli"];

// Default setup
_attachments = [_silencer1, _attach1,_scope2]; // The default attachment set for most units, overwritten in the individual unitType

// Predefined Class Attachment Setup
_attach_co = [_silencer1, _attach1,_scope2];
_attach_dc = [_silencer1, _attach1,_scope2]; // Also SL!
_attach_fl = [_silencer1, _attach1,_scope2];
_attach_mg = [_silencer2, _attach1,_scope2,_bipod1];
...
_rifle = ["srifle_h6_digi_rf","arifle_Mk20_F"];
_riflemag = "20Rnd_556x45_AP_Stanag_RF";
_riflemag_tr = "20Rnd_556x45_AP_Stanag_RF";

// Standard Carabineer (Medic, Rifleman (AT), MAT Gunner, MTR Gunner, Carabineer)
_carbine = ["srifle_h6_digi_rf","arifle_Mk20C_F"];
_carbinemag = "20Rnd_556x45_AP_Stanag_RF";
_carbinemag_tr = "20Rnd_556x45_AP_Stanag_RF";

// Standard Submachine Gun/Personal Defence Weapon (Aircraft Pilot, Submachinegunner)
_smg = "arifle_Mk20C_F";
_smgmag = "30Rnd_556x45_Stanag";
_smgmag_tr = "30Rnd_556x45_Stanag_Tracer_Yellow";
...
_bagmtrg = "I_E_CommandoMortar_weapon_RF";	// used by Mortar gunner
_bagmtrag = "I_E_CommandoMortar_weapon_RF";	// used by Mortar assistant gunner
...
// Marksman rifle
// NON-DLC ALTERNATIVE:
_DMrifle = ["srifle_DMR_07_blk_F","srifle_DMR_03_F","srifle_DMR_06_olive_F"];
