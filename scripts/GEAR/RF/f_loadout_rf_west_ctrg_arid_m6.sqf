...
_flashHider = "";
_silencer1 = ["muzzle_snds_H","muzzle_snds_M","muzzle_snds_m_snd_F"]; // Rifleman
_silencer2 = "muzzle_snds_M"; // MG

_scope1 = ["optic_ACO","optic_ACO_grn","optic_Holosight_blk_F"]; // CQB
_scope2 = ["optic_VRCO_RF","optic_MRCO","optic_Hamr","optic_ERCO_blk_F"]; // Low
...
// Automatic Rifleman
_AR = ["LMG_03_F","arifle_SPAR_02_blk_F"];
...
// Marksman rifle
_DMrifle = ["arifle_MXM_Black_F","arifle_SPAR_03_blk_F","srifle_DMR_02_camo_F","srifle_DMR_06_camo_F","srifle_DMR_03_khaki_F"];
...
_baseUniform = ["U_B_CTRG_Soldier_Arid_F"];
_baseHelmet = ["H_HelmetB_TI_arid_F"];
_baseGlasses = ["G_Balaclava_TI_G_tna_F"];
...
if (_isMan) then {
	...
	_unit addItem "H_Watchcap_khk";// Free Hat!
};
