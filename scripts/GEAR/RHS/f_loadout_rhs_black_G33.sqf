...
_rifle = "hlc_rifle_hk33a2RIS"; // "rhs_weap_m4a1_blockII","rhs_weap_m4a1_blockII_grip2","rhs_weap_mk18","rhs_weap_mk18_grip2"
_riflemag = "hlc_30rnd_556x45_EPR_HK33";
_riflemag_tr = "hlc_30rnd_556x45_t_HK33";

// Standard Carabineer (Medic, Rifleman (AT), MAT Gunner, MTR Gunner, Carabineer)
_carbine = "hlc_rifle_hk53RAS";
_carbinemag = "hlc_30rnd_556x45_EPR_HK33";
_carbinemag_tr = "hlc_30rnd_556x45_t_HK33";
...
_glrifle = "hlc_rifle_hk33a2RIS_GL";
_glriflemag = "hlc_30rnd_556x45_EPR_HK33";
_glriflemag_tr = "hlc_30rnd_556x45_t_HK33";
...
_baseUniform = ["rhs_uniform_g3_blk"];
_baseHelmet = ["rhssaf_helmet_m97_black_nocamo"]; // rhsusf_opscore_bk
_baseGlasses = ["G_Balaclava_blk","G_Balaclava_blk",""];
...
// Crewman
_crewUniform = ["rhs_uniform_g3_blk"];
_crewHelmet = ["H_HelmetCrew_B"];
_crewRig = ["rhsusf_spc"];
_crewGlasses = ["rhs_googles_clear"];

// Ghillie
_ghillieUniform = ["rhs_uniform_g3_blk"]; //DLC alternatives: ["U_B_FullGhillie_lsh","U_B_FullGhillie_ard","U_B_FullGhillie_sard"];
_ghillieHelmet = ["usm_bdu_boonie_blk"];
_ghillieRig = ["V_Chestrig_rgr"];
_ghillieGlasses = [];

// Spec Op
_sfuniform = ["rhs_uniform_g3_blk"];
...
switch (_typeofUnit) do
{
	...
	case "r":
	{
		...
		[_unit, _rifle] call f_fnc_addWeapon;
		_unit addMagazines [_smokegrenade,3];
		_unit addMagazines [_grenadealt,2];
		_unit addMagazines [_grenade,2];
	};
