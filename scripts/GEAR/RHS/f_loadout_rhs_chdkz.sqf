...
// Woodland-Hex
_baseUniform = ["rhsgref_uniform_reed","rhsgref_uniform_specter","rhs_uniform_mvd_izlom"];
_baseHelmet = ["rhs_beanie","rhs_beanie_green","H_Bandanna_gry"];
...
// Vests
_lightRig = ["V_TacVest_camo","V_I_G_resistanceLeader_F"];
_mediumRig = ["rhs_6sh92_digi","rhs_6sh92_digi_vog","rhs_6sh92_digi_radio"]; 	// default for all infantry classes
...
// Pilot
_pilotUniform = ["rhsgref_uniform_reed","rhsgref_uniform_specter","rhs_uniform_mvd_izlom"];
_pilotHelmet = ["rhs_tsh4"];
_pilotRig = ["rhs_6b23_digi"];
_pilotGlasses = [];

// Crewman
_crewUniform = ["rhsgref_uniform_reed","rhsgref_uniform_specter","rhs_uniform_mvd_izlom"];
...
switch (_typeofUnit) do
{
	...
	case "co":
	{
		_unit addHeadGear "rhsgref_patrolcap_specter";
		["g"] call _backpack;
