...
_silencer1 = ["muzzle_snds_H","muzzle_snds_B","muzzle_snds_H_SW"]; // INF suppressor
_silencer2 = ["muzzle_snds_H","muzzle_snds_338_green","muzzle_snds_338_black"]; // SNP suppressor

_scope1 = ["optic_ACO_grn","optic_Aco","FHQ_optic_AIM","FHQ_optic_HWS","FHQ_optic_AC11704","FHQ_optic_AC12136"]; // CQB BLK
_scope2 = ["rhsusf_acc_ACOG_RMR","optic_MRCO","optic_Hamr","FHQ_optic_AimM_BLK"]; // MED BLK
_scope3 = ["rhsusf_acc_ACOG_RMR","optic_SOS","optic_AMS","optic_AMS_khk","optic_LRPS","FHQ_optic_LeupoldERT"]; // MKSMAN BLK - "optic_Nightstalker"
...
// Marksman rifle
_DMrifle = ["arifle_MXM_Black_F","srifle_DMR_03_F","srifle_DMR_03_khaki_F"];
...
// Sniper
_SNrifle = ["srifle_DMR_02_camo_F","srifle_LRR_F","srifle_LRR_camo_F","srifle_DMR_02_F","rhs_weap_sr25"];
...
_baseHelmet = ["rhs_beanie_green"];
_baseGlasses = ["G_Bandanna_oli","G_Bandanna_beast","G_Bandanna_sport","G_Bandanna_khk","G_Bandanna_blk"];
