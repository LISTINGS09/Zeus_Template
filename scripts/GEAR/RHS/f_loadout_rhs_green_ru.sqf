...
_baseHelmet = ["rhs_6b7_1m_olive","rhs_6b7_1m_bala2_olive","rhs_6b7_1m_bala1_olive"];
_baseGlasses = [""];
...
_mediumRig = ["rhs_6b23_6sh116_vog_od","rhs_6b23_6sh116_od"]; 	// default for all infantry classes
