...
_rifle = ["rhs_weap_hk416d145","rhs_weap_m16a4_carryhandle","rhs_weap_mk18_KAC","rhs_weap_mk18"];
_riflemag = "30Rnd_556x45_Stanag";
_riflemag_tr = "30Rnd_556x45_Stanag_Tracer_Red";

// Standard Carbine (Medic, Rifleman (AT), MAT Gunner, MTR Gunner, Carbine)
_carbine = ["rhs_weap_hk416d10","rhs_weap_m4_carryhandle"];
...
_glrifle = ["rhs_weap_hk416d145_m320","rhs_weap_m16a4_carryhandle_M203","rhs_weap_mk18_m320"];
...
_baseUniform = ["rhs_uniform_g3_rgr"];
_baseHelmet = ["rhsusf_opscore_fg"];
_baseGlasses = ["G_Balaclava_blk","G_Balaclava_oli",""];

// Vests
_lightRig = ["V_Chestrig_rgr"];
_mediumRig = ["rhsgref_otv_khaki"]; 	// default for all infantry classes
...
// Crewman
_crewUniform = ["rhs_uniform_g3_rgr"];
_crewHelmet = ["H_HelmetCrew_I"];
_crewRig = ["V_TacVest_khk"];
_crewGlasses = ["rhs_ess_black"];

// Ghillie
_ghillieUniform = ["rhs_uniform_g3_rgr"]; //DLC alternatives: ["U_B_FullGhillie_lsh","U_B_FullGhillie_ard","U_B_FullGhillie_sard"];
_ghillieHelmet = ["H_Booniehat_oli"];
_ghillieRig = ["V_Chestrig_rgr"];
_ghillieGlasses = [];

// Spec Op
_sfuniform = ["rhs_uniform_g3_rgr"];
