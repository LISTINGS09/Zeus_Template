...
_baseHelmet = "rhsgref_ssh68_vsr";
_baseGlasses = "";

// Vests
_lightRig = "rhs_6sh92_vsr";
_mediumRig = "rhs_6sh92_vsr_radio"; 	// default for all infantry classes
_heavyRig = "rhs_6b5_vsr";
...
// Pilot
_pilotUniform = ["rhsgref_uniform_vsr"];
