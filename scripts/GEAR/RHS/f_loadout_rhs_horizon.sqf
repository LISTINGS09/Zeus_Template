...
_rifle = "rhs_weap_m16a4_carryhandle"; // "rhs_weap_m4a1_blockII","rhs_weap_m4a1_blockII_grip2","rhs_weap_mk18","rhs_weap_mk18_grip2"
...
// Backpacks
_bagsmall = "rhs_medic_bag";
_bagmedium = "B_FieldPack_oli";
_baglarge = "rhsgref_hidf_alicepack";
...
_baseUniform = ["rhsgref_uniform_ERDL"];
...
// Vests
_lightRig = ["rhsgref_alice_webbing"];
_mediumRig = ["rhsgref_alice_webbing"]; 	// default for all infantry classes
_heavyRig = ["rhsgref_alice_webbing"];
...
// Pilot
_pilotUniform = ["rhsgref_uniform_ERDL"];
_pilotHelmet = ["rhsusf_bowman_cap","rhsusf_Bowman"];
_pilotRig = ["rhsgref_alice_webbing"];
_pilotGlasses = ["rhs_googles_clear"];

// Crewman
_crewUniform = ["rhsgref_uniform_ERDL"];
_crewHelmet = ["rhsusf_cvc_green_helmet"];
_crewRig = ["rhsgref_alice_webbing"];
_crewGlasses = ["rhs_googles_clear"];

// Ghillie
_ghillieUniform = ["rhsgref_uniform_ERDL"]; //DLC alternatives: ["U_B_FullGhillie_lsh","U_B_FullGhillie_ard","U_B_FullGhillie_sard"];
_ghillieHelmet = ["H_Bandanna_camo"];
_ghillieRig = ["usm_vest_LBE_gr"];
_ghillieGlasses = [];

// Spec Op
_sfuniform = ["rhsgref_uniform_ERDL"];
_sfhelmet = ["H_Booniehat_oli"];
_sfRig = ["rhsgref_alice_webbing"];
_sfGlasses = [];
