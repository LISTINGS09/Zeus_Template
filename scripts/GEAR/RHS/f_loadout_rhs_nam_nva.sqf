...
_riflemag = "rhs_30Rnd_762x39mm_tracer";
_riflemag_tr = "rhs_30Rnd_762x39mm_tracer";

// Standard Carabineer (Medic, Rifleman (AT), MAT Gunner, MTR Gunner, Carabineer)
_carbine = "rhs_weap_m70b3n";
_carbinemag = "rhs_30Rnd_762x39mm_tracer";
_carbinemag_tr = "rhs_30Rnd_762x39mm_tracer";

// Standard Submachine Gun/Personal Defence Weapon (Aircraft Pilot, Submachinegunner)
_smg = "rhs_weap_m70b3n";
_smgmag = "rhs_30Rnd_762x39mm_tracer";
...
_glriflemag = "rhs_30Rnd_762x39mm_tracer";
...
// Backpacks
_bagsmall = "usm_pack_762x51_bandoliers";	// carries 120, weighs 20
_bagmedium = "rhs_sidor";					// carries 200, weighs 30
_baglarge =  "B_FieldPack_oli";				// carries 320, weighs 40
...
// Automatic Rifleman
_AR = "rhs_weap_m84";
_ARmag = "rhs_100Rnd_762x54mmR_green";
_ARmag_tr = "rhs_100Rnd_762x54mmR_green";

// Medium MG
_MMG = "rhs_weap_m84";
_MMGmag = "rhs_100Rnd_762x54mmR_green";
_MMGmag_tr = "rhs_100Rnd_762x54mmR_green";

// Marksman rifle
_DMrifle = "rhs_weap_kar98k";
_DMriflemag = "rhsgref_5Rnd_792x57_kar98k";
...
// Woodland-Hex
_baseUniform = ["U_I_C_Soldier_Bandit_1_F","U_I_C_Soldier_Bandit_5_F"];
_baseHelmet = ["rhsgref_M56"];
_baseGlasses = [""];
...
// Vests
_lightRig = ["V_BandollierB_rgr", "V_BandollierB_oli"];
_mediumRig = ["V_TacChestrig_grn_F","V_TacChestrig_oli_F"]; 	// default for all infantry classes
_heavyRig = "rhsgref_TacVest_ERDL";
...
// Pilot
_pilotUniform = ["U_I_C_Soldier_Bandit_1_F","U_I_C_Soldier_Bandit_5_F"];
_pilotHelmet = ["rhs_tsh4"];
_pilotRig = ["V_Chestrig_oli"];
_pilotGlasses = [];

// Crewman
_crewUniform = ["U_I_C_Soldier_Bandit_1_F","U_I_C_Soldier_Bandit_5_F"];
_crewHelmet = ["rhsgref_M56"];
_crewRig = ["V_Chestrig_oli"];
_crewGlasses = [];

// Ghillie
_ghillieUniform = ["U_I_C_Soldier_Bandit_1_F"]; //DLC alternatives: ["U_O_FullGhillie_lsh","U_O_FullGhillie_ard","U_O_FullGhillie_sard"];
_ghillieHelmet = [];
...
// LOADOUT: CARABINEER
   ...
   default
   {
		...
		if (true) exitWith {diag_log text format ["[F3] DEBUG (f\assignGear\f_loadout_rhs_nam_nva.sqf): Unit = %1. Gear template %2 does not exist, used Rifleman instead.",_unit,_typeofUnit]};
   };
