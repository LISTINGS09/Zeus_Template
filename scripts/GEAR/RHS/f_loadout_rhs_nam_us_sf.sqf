...
_baseHelmet = ["usm_bdu_boonie_erdl", "usm_bdu_boonie_odg"]; // ["rhs_Booniehat_m81","H_Booniehat_oli"];
_baseGlasses = ["G_Spectacles","","",""];

// Vests
_lightRig = ["usm_vest_LBE_rm"];
_mediumRig = ["usm_vest_rba_lbv_mg","usm_vest_rba_lbv_rm"]; 	// default for all infantry classes
