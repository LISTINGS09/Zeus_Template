...
// Woodland-Hex
_baseUniform = ["rhsgref_uniform_alpenflage"];
_baseHelmet = ["rhsgref_Booniehat_alpen"];
...
_mediumRig = ["V_TacVest_camo","V_I_G_resistanceLeader_F","V_TacVest_blk"]; 	// default for all infantry classes
