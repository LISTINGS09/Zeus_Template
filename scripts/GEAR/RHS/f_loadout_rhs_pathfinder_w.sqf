...
_glrifle = "rhs_weap_hk416d145_m320";
...
_baseUniform = ["U_I_CombatUniform","tb_alfr_SOFCombatUniform_shortsleeve_AFPATA"];
_baseHelmet = "H_HelmetIA";
_baseGlasses = ["rhs_googles_black","G_Bandanna_khk","G_Bandanna_tan",""];

// Vests
_lightRig = ["V_TacVest_khk","V_TacVest_brn"];
