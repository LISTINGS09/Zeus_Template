...
_baseHelmet = ["rhs_6b26","rhs_6b26_bala"];
_baseGlasses = [""];
...
// Vests
_lightRig = ["rhs_6b23"];
_mediumRig = ["rhs_6b23_6sh92","rhs_6b23_6sh92_vog","rhs_6b23_rifleman"]; 	// default for all infantry classes
_heavyRig = "rhs_6b23_vydra_3m";
