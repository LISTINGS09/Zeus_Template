...
_carbine = "rhs_weap_ak74m_desert_folded";
...
_mediumRig = ["rhs_6b23_ML_6sh92","rhs_6b23_ML_rifleman"]; 	// default for all infantry classes
...
// Ghillie
_ghillieUniform = "U_O_FullGhillie_ard"; //DLC alternatives: ["U_O_FullGhillie_lsh","U_O_FullGhillie_ard","U_O_FullGhillie_sard"];
_ghillieHelmet = "";
...
// LOADOUT: CARABINEER
   ...
   default
   {
		...
		if (true) exitWith {diag_log text format ["[F3] DEBUG (f\assignGear\f_loadout_rhs_rus_mflora.sqf): Unit = %1. Gear template %2 does not exist, used Rifleman instead.",_unit,_typeofUnit]};
   };
