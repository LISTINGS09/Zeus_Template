...
_attach_dc = [_scope2,_attach1,_silencer1]; // Also SL!
_attach_fl = [_scope2,_attach1,_silencer1];
...
// Woodland-Hex
_baseUniform = ["rhsgref_uniform_para_ttsko_mountain"];
_baseHelmet = ["rhs_altyn_novisor_bala","rhs_altyn_novisor_ess_bala","rhs_altyn_novisor"];
_baseGlasses = [""];
...
// Vests
_lightRig = ["rhsgref_6b23_ttsko_mountain"];
_mediumRig = ["rhsgref_6b23_ttsko_mountain_rifleman"]; 	// default for all infantry classes
_heavyRig = ["rhsgref_6b23_ttsko_mountain_rifleman"];
