...
_attach_co = [_flashHider,_scope2,_attach1,_silencer1];
_attach_dc = [_flashHider,_scope2,_attach1,_silencer1]; // Also SL!
_attach_fl = [_flashHider,_scope2,_attach1,_silencer1];
...
// Backpacks
_bagsmall = "rhs_rd54_vest";				// carries 120, weighs 20
_bagmedium = "rhs_rk_sht_30_olive";			// carries 200, weighs 30
_baglarge =  "rhsgref_tortila_specter"; 	// carries 320, weighs 40
...
// Medium MG
_MMG = "arifle_RPK12_F";
_MMGmag = "rhs_75Rnd_762x39mm";
_MMGmag_tr = "rhs_75Rnd_762x39mm_tracer";
...
// Woodland-Hex
_baseUniform = ["rhs_uniform_afghanka_spetsodezhda"];
_baseHelmet = ["rhs_6b7_1m_olive","rhs_6b7_1m_bala1_olive","rhs_6b7_1m_bala2_olive"];
_baseGlasses = [""];
