...
// Woodland-Hex
_baseUniform = ["rhs_uniform_gorka_r_y"];
_baseHelmet = ["rhs_beanie"];
_baseGlasses = ["rhs_scarf","G_Bandanna_khk",""];
...
// Crewman
_crewUniform = ["rhs_uniform_gorka_r_y"];
_crewHelmet = ["rhs_tsh4","rhs_tsh4_ess","rhs_tsh4_bala","rhs_tsh4_ess_bala"];
_crewRig = ["rhs_vydra_3m"];
_crewGlasses = [];

// Ghillie
_ghillieUniform = ["rhs_uniform_gorka_r_y"]; //DLC alternatives: ["U_O_FullGhillie_lsh","U_O_FullGhillie_ard","U_O_FullGhillie_sard"];
_ghillieHelmet = [];
