...
_glflare = "Chemlight_green";
_glflarealt = "Chemlight_red";
_glflareyellow = "Chemlight_yellow";
_glflaregreen = "Chemlight_green";
...
// Marksman rifle
_DMrifle = ["rhs_weap_m14ebrri","srifle_DMR_03_F","srifle_DMR_06_olive_F"];
...
_baseHelmet = ["usm_bdu_boonie_tgrstp","usm_bdu_boonie_odg"];
_baseGlasses = ["G_Balaclava_blk","G_Balaclava_oli",""];

// Vests
_lightRig = "V_TacVest_oli";
_mediumRig = "usm_vest_lbv_rmp"; 	// default for all infantry classes
_heavyRig = "usm_vest_rba_lbv_rm";
...
// Ghillie
_ghillieUniform = ["rhsgref_uniform_tigerstripe"]; //DLC alternatives: ["U_B_FullGhillie_lsh","U_B_FullGhillie_ard","U_B_FullGhillie_sard"];
_ghillieHelmet = ["H_Bandanna_camo"];
_ghillieRig = ["V_TacVest_oli"];
_ghillieGlasses = [];

// Spec Op
_sfuniform = ["rhsgref_uniform_tigerstripe"];
_sfhelmet = ["H_HelmetSpecB","H_HelmetSpecB_paint1","H_HelmetSpecB_paint2","H_HelmetSpecB_blk"];
_sfRig = ["usm_vest_rba_lbv_rm"];
_sfGlasses = [];
...
switch (_typeofUnit) do
{
	...
	case "co":
	{
		_unit addHeadGear "usm_bdu_8point_tgrstp";
		["g"] call _backpack;
