...
// Backpacks
_bagsmall = "rhs_rd54";						// carries 120, weighs 20
_bagmedium = "rhs_rd54";					// carries 200, weighs 30
_baglarge =  "rhs_tortila_grey"; 			// carries 320, weighs 40
...
_mediumRig = ["rhssaf_vest_md12_digital_desert"]; 	// default for all infantry classes
_heavyRig = ["rhssaf_vest_md12_digital_desert"];
...
if (_isMan) then {
	...
	_unit addItem "rhssaf_bandana_digital_desert";	// Free Hat!
