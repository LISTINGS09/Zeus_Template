...
_smg = ["rhs_weap_m21s"];
_smgmag = "rhsgref_30rnd_556x45_m21";
_smgmag_tr = "rhsgref_30rnd_556x45_m21_t";
...
_mediumRig = ["rhsgref_6b23_ttsko_mountain","rhsgref_6b23_ttsko_mountain_sniper"]; 	// default for all infantry classes
...
// Crewman
_crewUniform = ["rhsgref_uniform_para_ttsko_mountain"];
_crewHelmet = ["rhs_tsh4","rhs_tsh4_ess","rhs_tsh4_bala","rhs_tsh4_ess_bala"];
_crewRig = ["rhs_vydra_3m"];
_crewGlasses = [];

// Ghillie
_ghillieUniform = ["rhsgref_uniform_para_ttsko_mountain"]; //DLC alternatives: ["U_O_FullGhillie_lsh","U_O_FullGhillie_ard","U_O_FullGhillie_sard"];
_ghillieHelmet = [];
_ghillieRig = ["rhs_6b23_digi"];
_ghillieGlasses = [];

// Spec Op
_sfuniform = ["rhsgref_uniform_para_ttsko_mountain"];
_sfhelmet = ["rhsgref_ssh68_ttsko_mountain"];
