...
_rifle = ["rhs_weap_m4","rhs_weap_m4_grip","rhs_weap_m4_grip2","rhs_weap_m4_carryhandle","rhs_weap_m16a4_carryhandle","rhs_weap_m16a4_carryhandle_grip"];
...
_glrifle = ["rhs_weap_m4_m203","rhs_weap_m4_m203S","rhs_weap_m16a4_carryhandle_M203"];
...
// Sniper
_SNrifle = ["rhs_weap_XM2010_d","srifle_DMR_02_F","srifle_LRR_F"];
...
_baseHelmet = ["rhsusf_ach_helmet_ocp","rhsusf_ach_helmet_headset_ocp","rhsusf_ach_helmet_ocp_norotos"];
_baseGlasses = ["rhs_ess_black","rhs_googles_black",""];

// Vests
_lightRig = ["rhsusf_iotv_ocp"];
_mediumRig = ["rhsusf_iotv_ocp_Rifleman","rhsusf_iotv_ocp_Repair","rhsusf_iotv_ocp_SAW","rhsusf_iotv_ocp_Squadleader","rhsusf_iotv_ocp_Teamleader"]; 	// default for all infantry classes
...
// LOADOUT: CARABINEER
   ...
   default
   {
		...
		if (true) exitWith {diag_log text format ["[F3] DEBUG (f\assignGear\f_loadout_rhs_us_amry_ocp.sqf): Unit = %1. Gear template %2 does not exist, used Rifleman instead.",_unit,_typeofUnit]};
   };
