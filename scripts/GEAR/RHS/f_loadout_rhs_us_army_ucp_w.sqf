...
// Marksman rifle
_DMrifle = ["rhs_weap_m14ebrri_leu","rhs_weap_sr25","srifle_DMR_03_F","srifle_DMR_03_multicam_F"];
...
// Sniper
_SNrifle = ["rhs_weap_XM2010","rhs_weap_XM2010_wd_leu","srifle_DMR_02_F","srifle_LRR_F"];
...
_baseHelmet = ["rhsusf_ach_helmet_ucp","rhsusf_ach_helmet_headset_ucp","rhsusf_ach_helmet_ucp_norotos"];
_baseGlasses = ["rhs_googles_black","rhs_googles_clear",""];

// Vests
_lightRig = ["rhsusf_iotv_ucp"];
_mediumRig = ["rhsusf_iotv_ucp_Rifleman","rhsusf_iotv_ucp_Repair","rhsusf_iotv_ucp_SAW","rhsusf_iotv_ucp_Squadleader","rhsusf_iotv_ucp_Teamleader"]; 	// default for all infantry classes
...
if (_isMan) then {
	...
	//_unit addItem "rhs_Booniehat_ucp";		// Free Hat!
...
// LOADOUT: CARABINEER
   ...
   default
   {
		...
		if (true) exitWith {diag_log text format ["[F3] DEBUG (f\assignGear\f_loadout_rhs_us_amry_ucp.sqf): Unit = %1. Gear template %2 does not exist, used Rifleman instead.",_unit,_typeofUnit]};
   };
