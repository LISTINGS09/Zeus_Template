...
_rifle = "rhs_weap_m4_carryhandle"; // "rhs_weap_m4a1_blockII","rhs_weap_m4a1_blockII_grip2","rhs_weap_mk18","rhs_weap_mk18_grip2"
...
// Diver
_diverWep = "rhs_weap_m4_carryhandle";
...
_baseUniform = ["U_I_C_Soldier_Para_4_F","U_I_C_Soldier_Para_1_F"];
_baseHelmet = ["rhs_Booniehat_m81","H_Booniehat_oli"];
_baseGlasses = ["G_Spectacles","","",""];

// Vests
_lightRig = ["usm_vest_LBE_rm"];
_mediumRig = ["usm_vest_LBE_rm","usm_vest_LBE_mg"]; 	// default for all infantry classes
...
// Pilot
_pilotUniform = ["U_I_C_Soldier_Para_3_F"];
...
// Ghillie
_ghillieUniform = ["U_I_C_Soldier_Para_3_F"]; //DLC alternatives: ["U_B_FullGhillie_lsh","U_B_FullGhillie_ard","U_B_FullGhillie_sard"];
_ghillieHelmet = ["H_Bandanna_camo"];
_ghillieRig = ["usm_vest_LBE_gr"];
_ghillieGlasses = [];

// Spec Op
_sfuniform = ["U_I_C_Soldier_Para_3_F"];
