...
_scope1 = ["FHQ_optic_AIM","optic_Aco","FHQ_optic_HWS","rhsusf_acc_eotech_552","FHQ_optic_AC11704"]; // CQB BLK
...
_glrifle = ["rhs_weap_m4a1_carryhandle_m203","rhs_weap_m4a1_carryhandle_m203S","rhs_weap_m4a1_m320"];
...
// Backpacks
_bagsmall = "rhsusf_falconii_coy";
_bagmedium = "rhsusf_assault_eagleaiii_coy";
_baglarge = "rhsusf_assault_eagleaiii_coy";
...
_mediumRig = ["rhsusf_spc_mg","rhsusf_spc_rifleman","rhsusf_spc_corpsman","rhsusf_spc_squadleader"]; 	// default for all infantry classes
