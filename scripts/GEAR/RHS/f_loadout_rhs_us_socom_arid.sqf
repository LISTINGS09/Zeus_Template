...
_scope1 = ["rhsusf_acc_eotech_552_d","FHQ_optic_AIM","optic_Aco","FHQ_optic_HWS","rhsusf_acc_eotech_552","FHQ_optic_AC11704"]; // CQB BLK
...
_rifle = ["rhs_weap_m4a1_d","rhs_weap_m4a1","rhs_weap_m4a1_grip","rhs_weap_m4a1_grip2","rhs_weap_m4a1_carryhandle"]; // "rhs_weap_m4a1_blockII","rhs_weap_m4a1_blockII_grip2","rhs_weap_mk18","rhs_weap_mk18_grip2"
_riflemag = "30Rnd_556x45_Stanag";
_riflemag_tr = "30Rnd_556x45_Stanag_Tracer_Red";

// Standard Carabineer (Medic, Rifleman (AT), MAT Gunner, MTR Gunner, Carabineer)
_carbine = ["rhs_weap_m4a1_d","rhs_weap_m4a1","rhs_weap_m4a1_grip","rhs_weap_m4a1_grip2","rhs_weap_m4a1_carryhandle"];
...
_glrifle = ["rhs_weap_m4a1_m203s_d","rhs_weap_m4a1_carryhandle_m203","rhs_weap_m4a1_carryhandle_m203S","rhs_weap_m4a1_m320"];
...
// Backpacks
_bagsmall = "rhsusf_falconii_mc";
_bagmedium = "rhsusf_assault_eagleaiii_ocp";
_baglarge = "rhsusf_assault_eagleaiii_ocp";
...
_baseUniform = ["rhs_uniform_g3_mc"];
_baseHelmet = ["rhsusf_mich_bare_norotos","rhsusf_mich_bare_norotos_arc"];
_baseGlasses = ["rhs_googles_orange","rhs_googles_clear","rhs_googles_yellow",""];

// Vests
_lightRig = ["rhsusf_mbav"];
_mediumRig = ["rhsusf_mbav_mg","rhsusf_mbav_rifleman"]; 	// default for all infantry classes
...
if (_isMan) then {
	...
	_unit addItem "rhs_Booniehat_ocp";		// Free Hat!
