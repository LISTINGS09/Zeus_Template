...
_silencer1 = ["rhsusf_acc_aac_762sd_silencer"]; // INF suppressor
_silencer2 = ["hlc_muzzle_556NATO_M42000"]; // SNP suppressor
...
// Default setup
_attachments = [_flashHider,_attach1,_scope2,_silencer1]; // The default attachment set for most units, overwritten in the individual unitType
...
_attach_fl = [_flashHider,_attach1,_scope2,_silencer1];
_attach_mg = [_flashHider,_attach1,_scope2,_bipod1,_silencer2];
...
_rifle = ["rhs_weap_SCARH_FDE_STD","rhs_weap_m16a4_carryhandle","rhs_weap_m16a4_carryhandle_grip","rhs_weap_m4","rhs_weap_m4_grip","rhs_weap_m4_grip2","rhs_weap_m4_carryhandle"];
_riflemag = "rhs_mag_20Rnd_SCAR_762x51_m80_ball_bk";
_riflemag_tr = "rhs_mag_20Rnd_SCAR_762x51_m62_tracer";

// Standard Carbine (Medic, Rifleman (AT), MAT Gunner, MTR Gunner, Carbine)
_carbine = ["rhs_weap_SCARH_FDE_CQC","rhs_weap_m4","rhs_weap_m4_grip","rhs_weap_m4_grip2","rhs_weap_m4_carryhandle"];
_carbinemag = "rhs_mag_20Rnd_SCAR_762x51_m80_ball_bk";
