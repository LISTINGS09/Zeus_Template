...
_rifle = "rhs_weap_kar98k"; // "rhs_weap_m4a1_blockII","rhs_weap_m4a1_blockII_grip2","rhs_weap_mk18","rhs_weap_mk18_grip2"
_riflemag = "rhsgref_5Rnd_792x57_kar98k";
_riflemag_tr = "rhsgref_5Rnd_792x57_kar98k";

// Standard Carabineer (Medic, Rifleman (AT), MAT Gunner, MTR Gunner, Carabineer)
_carbine = "rhs_weap_kar98k";
_carbinemag = "rhsgref_5Rnd_792x57_kar98k";
_carbinemag_tr = "rhsgref_5Rnd_792x57_kar98k";

// Standard Submachine Gun/Personal Defence Weapon (Aircraft Pilot, Submachinegunner)
_smg = "rhs_weap_MP44";
_smgmag = "rhsgref_30Rnd_792x33_SmE_StG";
_smgmag_tr = "rhsgref_30Rnd_792x33_SmE_StG";

// Diver
_diverWep = "rhs_weap_MP44";
_diverMag1 = "rhsgref_30Rnd_792x33_SmE_StG";
_diverMag2 = "rhsgref_30Rnd_792x33_SmE_StG";

// Rifle with GL and HE grenades (CO, DC, FTLs)
_glrifle = "rhs_weap_MP44";
_glriflemag = "rhsgref_30Rnd_792x33_SmE_StG";
_glriflemag_tr = "rhsgref_30Rnd_792x33_SmE_StG";
...
// Backpacks
_bagsmall = "rhs_assault_umbts";
_bagmedium = "rhs_assault_umbts";
_baglarge = "rhs_assault_umbts";
...
_baseUniform = ["rhsgref_uniform_olive"];
_baseHelmet = ["rhsgref_M56"]; // ["rhs_Booniehat_m81","H_Booniehat_oli"];
_baseGlasses = ["G_Squares","","",""];
...
// Ghillie
_ghillieUniform = ["rhsgref_uniform_olive"]; //DLC alternatives: ["U_B_FullGhillie_lsh","U_B_FullGhillie_ard","U_B_FullGhillie_sard"];
_ghillieHelmet = ["H_Bandanna_camo"];
_ghillieRig = ["usm_vest_LBE_gr"];
_ghillieGlasses = [];

// Spec Op
_sfuniform = ["rhsgref_uniform_olive"];
