...
_rifle = "rhs_weap_m1garand_sa43"; // "rhs_weap_m4a1_blockII","rhs_weap_m4a1_blockII_grip2","rhs_weap_mk18","rhs_weap_mk18_grip2"
_riflemag = "rhsgref_8Rnd_762x63_M2B_M1rifle";
_riflemag_tr = "rhsgref_8Rnd_762x63_M2B_M1rifle";

// Standard Carabineer (Medic, Rifleman (AT), MAT Gunner, MTR Gunner, Carabineer)
_carbine = "rhs_weap_m1garand_sa43";
_carbinemag = "rhsgref_8Rnd_762x63_M2B_M1rifle";
_carbinemag_tr = "rhsgref_8Rnd_762x63_M2B_M1rifle";

// Standard Submachine Gun/Personal Defence Weapon (Aircraft Pilot, Submachinegunner)
_smg = "rhs_weap_m3a1";
_smgmag = "rhsgref_30rnd_1143x23_M1911B_SMG";
_smgmag_tr = "rhsgref_30rnd_1143x23_M1911B_SMG";

// Diver
_diverWep = "rhs_weap_m3a1";
_diverMag1 = "rhsgref_30rnd_1143x23_M1911B_SMG";
_diverMag2 = "rhsgref_30rnd_1143x23_M1911B_SMG";

// Rifle with GL and HE grenades (CO, DC, FTLs)
_glrifle = "rhs_weap_m3a1";
_glriflemag = "rhsgref_30rnd_1143x23_M1911B_SMG";
_glriflemag_tr = "rhsgref_30rnd_1143x23_M1911B_SMG";
_glmag = "SmokeShellYellow";

// Smoke for FTLs, Squad Leaders, etc
_glsmoke = "SmokeShell";
_glsmokealt1 = "SmokeShellGreen";
_glsmokealt2 = "SmokeShellRed";

// Flares for FTLs, Squad Leaders, etc
_glflare = "rhs_mag_nspn_green";
_glflarealt = "rhs_mag_nspn_yellow";
...
// Backpacks
_bagsmall = "usm_pack_762x51_ammobelts";
_bagmedium = "usm_pack_762x51_ammobelts";
_baglarge = "usm_pack_762x51_ammobelts";
...
// Automatic Rifleman
_AR = "rhs_weap_mg42";
_ARmag = "rhsgref_50Rnd_792x57_SmE_drum";
_ARmag_tr = "rhsgref_50Rnd_792x57_SmK_alltracers_drum";
...
_baseHelmet = ["rhs_ssh68"]; // ["rhs_Booniehat_m81","H_Booniehat_oli"];
_baseGlasses = ["G_Spectacles","","",""];

// Vests
_lightRig = ["rhs_6sh46"];
_mediumRig = ["rhs_6sh46"]; 	// default for all infantry classes
_heavyRig = ["rhs_6sh46"];
...
_crewHelmet = ["rhs_ssh68"];
_crewRig = ["usm_vest_LBE_rm"];
_crewGlasses = ["rhs_googles_clear"];

// Ghillie
_ghillieUniform = ["rhs_uniform_m88_patchless"]; //DLC alternatives: ["U_B_FullGhillie_lsh","U_B_FullGhillie_ard","U_B_FullGhillie_sard"];
_ghillieHelmet = ["H_Bandanna_camo"];
_ghillieRig = ["usm_vest_LBE_gr"];
_ghillieGlasses = [];

// Spec Op
_sfuniform = ["rhs_uniform_m88_patchless"];
...
switch (_typeofUnit) do
{
	...
	case "aar":
	{
		...
		_unit addMagazines [_ARmag_tr,6];
	};
