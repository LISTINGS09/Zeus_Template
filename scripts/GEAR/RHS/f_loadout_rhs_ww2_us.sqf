...
// Automatic Rifleman
_AR = "hlc_lmg_m60";
_ARmag = "rhsusf_50Rnd_762x51";
_ARmag_tr = "rhsusf_50Rnd_762x51";

// Medium MG
_MMG = "hlc_lmg_m60";
_MMGmag = "rhsusf_50Rnd_762x51";
_MMGmag_tr = "rhsusf_50Rnd_762x51";
...
_baseUniform = ["rhsgref_uniform_og107"];
...
_mediumRig = ["usm_vest_LBE_rm"]; 	// default for all infantry classes
_heavyRig = ["usm_vest_LBE_rm"];
...
// Pilot
_pilotUniform = ["rhsgref_uniform_og107"];
...
// Ghillie
_ghillieUniform = ["rhsgref_uniform_og107"]; //DLC alternatives: ["U_B_FullGhillie_lsh","U_B_FullGhillie_ard","U_B_FullGhillie_sard"];
_ghillieHelmet = ["H_Bandanna_camo"];
_ghillieRig = ["usm_vest_LBE_gr"];
_ghillieGlasses = [];

// Spec Op
_sfuniform = ["rhsgref_uniform_og107"];
