...
// Automatic Rifleman
_AR = "vn_l2a1_01";
_ARmag = "vn_l1a1_30_02_mag";
_ARmag_tr = "vn_l1a1_30_02_t_mag";
...
// LOADOUT: CARABINEER
   ...
   default
   {
		...
		if (true) exitWith {diag_log text format ["[F3] DEBUG (f_loadout_sog_west_australia.sqf): Unit = %1. Gear template %2 does not exist!",_unit,_typeOfUnit]};
   };
