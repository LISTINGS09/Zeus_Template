...
_baseUniform = ["U_SPE_FR_HBT_Uniform"];
_baseHelmet = ["H_SPE_FR_Adrian"];
_baseGlasses = [""];
...
// Ghillie (MEDIC)
_ghillieUniform = ["U_SPE_US_HBT44_Med"];
_ghillieHelmet = ["H_SPE_FR_Adrian_Medic_ns"];
_ghillieRig = ["V_SPE_US_Vest_Medic"];
_ghillieGlasses = ["G_SPE_Ful_Vue"];
