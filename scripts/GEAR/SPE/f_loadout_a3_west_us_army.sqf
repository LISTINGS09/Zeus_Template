...
_smg = ["SPE_M1A1_Thompson","SPE_M3_GreaseGun"];
_smgmag = "SPE_30Rnd_Thompson_45ACP";
_smgmag_tr = "SPE_30Rnd_Thompson_45ACP_t";
...
_baseHelmet = ["H_SPE_US_Helmet_Net","H_SPE_US_Helmet_ns"];
_baseGlasses = [""];
...
_diverHelmet = ["H_SPE_US_Helmet_ns"];
...
// LOADOUT: CARABINEER
   ...
   default
   {
		...
		if (true) exitWith {diag_log text format ["[F3] DEBUG (f_loadout_a3_west_us_army.sqf): Unit = %1. Gear template %2 does not exist!",_unit,_typeOfUnit]};
   };
