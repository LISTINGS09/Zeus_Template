...
_rifle = ["rhs_weap_m4a1_blockII_d","rhs_weap_m4a1_blockII_KAC_d","rhs_weap_mk18_d","rhs_weap_mk18_KAC_d","rhs_weap_m4a1_blockII_bk","rhs_weap_mk18_bk","rhs_weap_m4","rhs_weap_m4_carryhandle","rhs_weap_m16a4_carryhandle"];
_riflemag = "30Rnd_556x45_Stanag";
_riflemag_tr = "30Rnd_556x45_Stanag_Tracer_Red";

// Standard Carabineer (Medic, Rifleman (AT), MAT Gunner, MTR Gunner, Carabineer)
_carbine = ["rhs_weap_mk18_d","rhs_weap_mk18_KAC_d","rhs_weap_mk18_bk","rhs_weap_m4","rhs_weap_m4_carryhandle"];
...
_glrifle = ["rhs_weap_m4a1_blockII_M203_d","rhs_weap_m4_m203","rhs_weap_m4_m203S","rhs_weap_m16a4_carryhandle_M203"];
...
// Binoculars
_binos1 = "Binocular";
_binos2 = ["Rangefinder","ACE_Vector"];
...
// Marksman rifle
_DMrifle = ["srifle_EBR_F","rhs_weap_m14ebrri_leu","rhs_weap_sr25","srifle_DMR_03_F","srifle_DMR_03_tan_F"];
...
// Sniper
_SNrifle = ["srifle_LRR_F","rhs_weap_XM2010_d","srifle_DMR_02_F"];
...
_baseHelmet = ["usm_helmet_pasgt_d"];
_baseGlasses = ["rhs_ess_black",""];

// Vests
_lightRig = ["usm_vest_pasgtdes"];
_mediumRig = ["usm_vest_pasgtdes_lbv_rm","usm_vest_pasgtdes_lbv_rmp","usm_vest_pasgtdes_lbv_gr"]; 	// default for all infantry classes
...
// Crewman
_crewUniform = ["usm_bdu_d"];
_crewHelmet = ["H_HelmetCrew_B"];
_crewRig = ["usm_vest_pasgtdes"];
_crewGlasses = ["rhs_googles_clear"];

// Ghillie
_ghillieUniform = ["usm_bdu_d"]; //DLC alternatives: ["U_B_FullGhillie_lsh","U_B_FullGhillie_ard","U_B_FullGhillie_sard"];
_ghillieHelmet = ["usm_bdu_boonie_des"];
_ghillieRig = ["usm_vest_pasgtdes"];
_ghillieGlasses = [];

// Spec Op
_sfuniform = ["usm_vest_lbv_rm_m"];
_sfhelmet = ["usm_bdu_boonie_des"];
_sfRig = ["usm_vest_pasgtdes"];
_sfGlasses = [];
...
if (_isMan) then {
	...
	//_unit addItem "usm_bdu_boonie_des";		// Free Hat!
