...
_baseHelmet = ["usm_bdu_boonie_ubn"];
...
// Crewman
_crewUniform = ["usm_bdu_ubn"];
_crewHelmet = ["tb_alfr_headset_01"];
_crewRig = ["V_TacVest_blk"];
_crewGlasses = ["rhs_googles_clear"];

// Ghillie
_ghillieUniform = ["usm_bdu_ubn"]; //DLC alternatives: ["U_B_FullGhillie_lsh","U_B_FullGhillie_ard","U_B_FullGhillie_sard"];
_ghillieHelmet = ["usm_bdu_boonie_ubn"];
_ghillieRig = ["V_TacVest_blk"];
_ghillieGlasses = [];

// Spec Op
_sfuniform = ["usm_vest_lbv_rm_m"];
_sfhelmet = ["usm_bdu_boonie_ubn"];
