...
_rifle = ["gst_m16a2"]; // "rhs_weap_m4a1_blockII","rhs_weap_m4a1_blockII_grip2","rhs_weap_mk18","rhs_weap_mk18_grip2"
_riflemag = "rhs_mag_30Rnd_556x45_M855_Stanag";
_riflemag_tr = "rhs_mag_30Rnd_556x45_M855_Stanag_Tracer_Red";

// Standard Carabineer (Medic, Rifleman (AT), MAT Gunner, MTR Gunner, Carabineer)
_carbine = ["gst_m16a2_2"];
_carbinemag = "rhs_mag_30Rnd_556x45_M855_Stanag";
...
_glriflemag = "rhs_mag_30Rnd_556x45_M855_Stanag";
...
// Marksman rifle
_DMrifle = ["rhs_weap_m14ebrri_leu","rhs_weap_sr25","srifle_DMR_03_F","srifle_DMR_03_woodland_F"];
...
_baseUniform = ["usm_bdum65_wdl"];
_baseHelmet = ["usm_helmet_pasgt_scrim_wdl"];
_baseGlasses = "";

// Vests
_lightRig = ["usm_vest_pasgt_lbe_rm"];
_mediumRig = ["usm_vest_pasgt_lbe_rmpr","usm_vest_pasgt_lbe_rm","usm_vest_pasgt_lbe_rm2"]; 	// default for all infantry classes
...
// Crewman
_crewUniform = ["usm_bdum65_wdl"];
_crewHelmet = ["usm_helmet_pasgt_g_w"];
_crewRig = ["usm_vest_pasgt"];
_crewGlasses = ["rhs_googles_clear"];

// Ghillie
_ghillieUniform = ["usm_bdum65_wdl"]; //DLC alternatives: ["U_B_FullGhillie_lsh","U_B_FullGhillie_ard","U_B_FullGhillie_sard"];
...
if (_isMan) then {
	...
	_unit addItem "gm_ge_facewear_m65"; 	// Add Mask
	_unit addItem "usm_rifle_cleaning_kit"; // Add Cleaning Kit
	_unit addItem "usm_militaryid";
	_unit addItem "usm_footpowder";
	_unit addItem "usm_scarf2";
	_unit addItem "usm_nvg_gigloves";
	_unit addItem "ACE_Flashlight_MX991"; 	// Add ACE Flash lights
	_unit addItem "usm_bdu_cap_wdl";		// Free Hat!
...
switch (_typeofUnit) do
{
	...
	case "ftl":
	{
		_bagsmall = "usm_pack_st128_prc77";
		["r"] call _backpack;
		_unit addMagazines [_riflemag,_defMags];
		_unit addMagazines [_riflemag_tr,_defMags_tr];
		[_unit, _rifle] call f_fnc_addWeapon;
