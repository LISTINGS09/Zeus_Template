...
// Backpacks
_bagsmall = "usm_pack_762x51_bandoliers";
...
_baseHelmet = ["usm_bdu_boonie_erdl","H_Booniehat_oli"]; // ["rhs_Booniehat_m81","H_Booniehat_oli"];
_baseGlasses = ["G_Spectacles","","",""];

// Vests
_lightRig = ["rhsgref_TacVest_ERDL"];
