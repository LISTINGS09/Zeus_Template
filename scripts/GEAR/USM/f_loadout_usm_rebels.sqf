...
_baseHelmet = ["usm_bdu_boonie_portliz","usm_bdu_boonie_odg"];
_baseGlasses = ["G_Balaclava_oli","G_Bandanna_oli",""];
...
// Pilot
_pilotUniform = ["rhs_chdkz_uniform_1","rhs_chdkz_uniform_2","rhs_chdkz_uniform_3","rhs_chdkz_uniform_4","rhs_chdkz_uniform_5"];
_pilotHelmet = ["rhs_tsh4"];
_pilotRig = ["rhs_6b23_digi"];
_pilotGlasses = [];

// Crewman
_crewUniform = ["rhs_chdkz_uniform_1","rhs_chdkz_uniform_2","rhs_chdkz_uniform_3","rhs_chdkz_uniform_4","rhs_chdkz_uniform_5"];
...
// Spec Op
_sfuniform = ["rhs_chdkz_uniform_1","rhs_chdkz_uniform_2","rhs_chdkz_uniform_3","rhs_chdkz_uniform_4","rhs_chdkz_uniform_5"];
...
switch (_typeofUnit) do
{
	...
	case "m":
	{
		_unit addHeadgear "usm_bdu_boonie_portliz";
