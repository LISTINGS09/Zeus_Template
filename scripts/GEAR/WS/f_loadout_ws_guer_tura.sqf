...
_glsmokealt1 = "1Rnd_50mm_Smoke_lxWS";
...
_bagmedium = "B_FieldPack_green_F";			// carries 240, weighs 30
...
_baseUniform = ["U_lxWS_Djella_02_Sand","U_lxWS_Djella_03_Green","U_lxWS_Djella_02_Grey","U_lxWS_Djella_02_Brown"];
_baseHelmet = ["lxWS_H_turban_03_black","lxWS_H_turban_03_green","lxWS_H_turban_03_sand","lxWS_H_turban_02_black","lxWS_H_turban_02_green","lxWS_H_turban_02_sand"];
_baseGlasses = [""];

// Vests
_lightRig = ["V_TacVest_khk"];
_mediumRig = ["V_lxWS_TacVestIR_oli"]; 	// default for all infantry classes
...
// Pilot
_pilotUniform = ["U_lxWS_SFIA_deserter"];
_pilotHelmet = ["lxWS_H_Headset"];
_pilotRig = ["V_lxWS_TacVestIR_oli"];
_pilotGlasses = [];

// Crewman
_crewUniform = ["U_lxWS_SFIA_deserter"];
_crewHelmet = ["lxWS_H_Headset"];
_crewRig = ["V_lxWS_TacVestIR_oli"];
_crewGlasses = [];

// Ghillie
_ghillieUniform = ["U_B_FullGhillie_ard"];
_ghillieHelmet = [];
_ghillieRig = ["V_lxWS_TacVestIR_oli"];
_ghillieGlasses = [];

// Spec Op
_sfuniform = ["U_lxWS_SFIA_deserter_O"];
_sfhelmet = ["lxWS_H_ssh40_green"];
_sfRig = ["V_lxWS_TacVestIR_oli"];
_sfGlasses = ["G_Bandanna_Oli"];
...
switch (_typeOfUnit) do
{
	...
	case "co":
	{
		_unit addHeadgear "lxWS_H_turban_03_orange";
		["g"] call _backpack;
	...
	case "dc":
	{
		_unit addHeadgear "lxWS_H_turban_02_red";
		["g"] call _backpack;
		_unit addMagazines [_glriflemag,_defMags];
		_unit addMagazines [_glriflemag_tr,_defMags_tr];
		_unit addMagazines [_glmag,3];
