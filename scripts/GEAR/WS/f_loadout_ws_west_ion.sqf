...
_scope2 = ["optic_ERCO_blk_F","optic_MRCO","optic_Arco","optic_Hamr"]; // Low
...
_baseUniform = ["U_lxWS_ION_Casual1"];
_baseHelmet = ["H_Cap_blk_ION","lxWS_H_bmask_camo01","lxWS_H_bmask_base","lxWS_H_bmask_white","lxWS_H_bmask_camo02","lxWS_H_bmask_yellow"];
...
// Spec Op
_sfuniform = ["U_lxWS_ION_Casual2","U_lxWS_ION_Casual4"];
_sfhelmet = ["lxWS_H_CapB_rvs_blk_ION","lxWS_H_bmask_camo01","lxWS_H_bmask_base","lxWS_H_bmask_white","lxWS_H_bmask_camo02","lxWS_H_bmask_yellow"];
...
if (_isMan) then {
	...
	_unit addItem "H_ShemagOpen_khk"; // Free hat!
};
...
switch (_typeOfUnit) do
{
	...
	case "dc":
	{
		_unit addHeadgear "lxWS_H_CapB_rvs_blk_ION";
		["g"] call _backpack;
		_unit addMagazines [_glriflemag,_defMags];
		_unit addMagazines [_glriflemag_tr,_defMags_tr];
		_unit addMagazines [_glmag,3];
