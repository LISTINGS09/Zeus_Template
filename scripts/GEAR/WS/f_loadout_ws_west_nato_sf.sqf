...
_attach_mg = [_attach1,_scope2,_silencer1,_bipod1];
...
_baseUniform = ["U_lxWS_B_CombatUniform_desert_vest"];
_baseHelmet = ["lxWS_H_Booniehat_desert"]; // ["H_HelmetB_sand","H_HelmetB_desert"];
