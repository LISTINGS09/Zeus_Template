...
_flashHider = "";
_silencer1 = ["muzzle_snds_65_TI_blk_F"]; // Rifleman
_silencer2 = ["muzzle_snds_H_MG_snd_F","muzzle_snds_H_MG","muzzle_snds_M"]; // MG

_scope1 = ["optic_Holosight_blk_F","optic_Holosight","optic_ACO","optic_ACO_grn"]; // CQB
_scope2 = ["optic_ERCO_blk_F","optic_ERCO_snd_F","optic_MRCO","optic_Arco","optic_Hamr"]; // Low
...
_riflemag = "35Rnd_556x45_Velko_lxWS";
_riflemag_tr = "35Rnd_556x45_Velko_lxWS";

// Standard Carabineer (Medic, Rifleman (AT), MAT Gunner, MTR Gunner, Carabineer)
_carbine = ["arifle_Velko_lxWS"];
_carbinemag = "35Rnd_556x45_Velko_lxWS";
_carbinemag_tr = "35Rnd_556x45_Velko_lxWS";
...
// Automatic Rifleman
_AR = ["arifle_Velko_lxWS"];
_ARmag = "50Rnd_556x45_Velko_lxWS";
_ARmag_tr = "50Rnd_556x45_Velko_lxWS";

// Medium MG
_MMG = ["MMG_02_black_F","MMG_02_sand_F"];
...
_baseUniform = ["U_lxWS_UN_Camo2","U_lxWS_UN_Camo3"];
_baseHelmet = ["lxWS_H_PASGT_basic_UN_F","lxWS_H_PASGT_goggles_UN_F"];
_baseGlasses = ["","","G_Bandanna_khk"];

// Vests
_lightRig = ["V_TacVest_khk"];
_mediumRig = ["V_lxWS_UN_Vest_Lite_F"]; 	// default for all infantry classes
_heavyRig = ["V_lxWS_UN_Vest_F"];
...
_pilotRig = ["V_lxWS_UN_Vest_Lite_F"];
_pilotGlasses = [];

// Crewman
_crewUniform = ["U_lxWS_UN_Camo2"];
_crewHelmet = ["lxWS_H_HelmetCrew_Blue"];
_crewRig = ["V_lxWS_UN_Vest_Lite_F"];
_crewGlasses = [];
